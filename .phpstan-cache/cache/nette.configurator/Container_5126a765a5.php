<?php
// source: phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
// source: /Users/mantum/Documents/test-paypal/phpstan.neon
// source: array
...
class Container_5126a765a5 extends _PHPStan_95d365e52\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.stubFilesExtension' => ['044' => true, '046' => true, '047' => true, '048' => true, '0531' => true],
		...
		'phpstan.dynamicFunctionThrowTypeExtension' => ['0224' => true, '0269' => true, '0271' => true],
		...
		'phpstan.dynamicMethodThrowTypeExtension' => ['0249' => true, '0250' => true, '0253' => true],
		'phpstan.functionParameterOutTypeExtension' => ['0272' => true, '0273' => true, '0275' => true],
		'phpstan.functionParameterClosureTypeExtension' => ['0276' => true],
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0295' => true],
		'phpstan.rules.rule' => [
			'0368' => true,
			'0369' => true,
			'0370' => true,
		...
		'phpstan.phpDoc.typeNodeResolverExtension' => ['0509' => true, '0510' => true, '0516' => true, '0520' => true],
	];

	protected $types = ['container' => '_PHPStan_95d365e52\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_95d365e52\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0142',
				'0143',
		...
		'PHPStan\Rules\Api\ApiInstanceofRule' => [['rules.13']],
		'PHPStan\Rules\Api\ApiInstanceofTypeRule' => [['rules.14']],
		'PHPStan\Rules\Api\ApiInstantiationRule' => [['rules.15']],
		'PHPStan\Rules\Api\ApiClassConstFetchRule' => [['rules.16']],
		'PHPStan\Rules\Api\ApiClassExtendsRule' => [['rules.17']],
		'PHPStan\Rules\Api\ApiClassImplementsRule' => [['rules.18']],
		'PHPStan\Rules\Api\ApiInterfaceExtendsRule' => [['rules.19']],
		'PHPStan\Rules\Api\ApiMethodCallRule' => [['rules.20']],
		'PHPStan\Rules\Api\ApiStaticCallRule' => [['rules.21']],
		'PHPStan\Rules\Api\ApiTraitUseRule' => [['rules.22']],
		'PHPStan\Rules\Api\GetTemplateTypeRule' => [['rules.23']],
		'PHPStan\Rules\Api\NodeConnectingVisitorAttributesRule' => [['rules.24']],
		'PHPStan\Rules\Api\OldPhpParser4ClassRule' => [['rules.25']],
		'PHPStan\Rules\Api\PhpStanNamespaceIn3rdPartyPackageRule' => [['rules.26']],
		'PHPStan\Rules\Api\RuntimeReflectionInstantiationRule' => [['rules.27']],
		'PHPStan\Rules\Api\RuntimeReflectionFunctionRule' => [['rules.28']],
		'PHPStan\Rules\Arrays\DuplicateKeysInLiteralArraysRule' => [['rules.29']],
		'PHPStan\Rules\Arrays\OffsetAccessWithoutDimForReadingRule' => [['rules.30']],
		'PHPStan\Rules\Cast\UnsetCastRule' => [['rules.31']],
		'PHPStan\Rules\Classes\AllowedSubTypesRule' => [['rules.32']],
		'PHPStan\Rules\Classes\ClassAttributesRule' => [['rules.33']],
		'PHPStan\Rules\Classes\ClassConstantAttributesRule' => [['rules.34']],
		'PHPStan\Rules\Classes\ClassConstantRule' => [['rules.35']],
		'PHPStan\Rules\Classes\DuplicateDeclarationRule' => [['rules.36']],
		'PHPStan\Rules\Classes\EnumSanityRule' => [['rules.37']],
		'PHPStan\Rules\Classes\InstantiationCallableRule' => [['rules.38']],
		'PHPStan\Rules\Classes\InvalidPromotedPropertiesRule' => [['rules.39']],
		'PHPStan\Rules\Classes\LocalTypeAliasesRule' => [['rules.40']],
		'PHPStan\Rules\Classes\LocalTypeTraitUseAliasesRule' => [['rules.41']],
		'PHPStan\Rules\Classes\LocalTypeTraitAliasesRule' => [['rules.42']],
		'PHPStan\Rules\Classes\NewStaticRule' => [['rules.43']],
		'PHPStan\Rules\Classes\NonClassAttributeClassRule' => [['rules.44']],
		'PHPStan\Rules\Classes\ReadOnlyClassRule' => [['rules.45']],
		'PHPStan\Rules\Classes\TraitAttributeClassRule' => [['rules.46']],
		'PHPStan\Rules\Constants\ClassAsClassConstantRule' => [['rules.47']],
		'PHPStan\Rules\Constants\DynamicClassConstantFetchRule' => [['rules.48']],
		'PHPStan\Rules\Constants\FinalConstantRule' => [['rules.49']],
		'PHPStan\Rules\Constants\MagicConstantContextRule' => [['rules.50']],
		'PHPStan\Rules\Constants\NativeTypedClassConstantRule' => [['rules.51']],
		'PHPStan\Rules\Constants\FinalPrivateConstantRule' => [['rules.52']],
		'PHPStan\Rules\EnumCases\EnumCaseAttributesRule' => [['rules.53']],
		'PHPStan\Rules\Exceptions\NoncapturingCatchRule' => [['rules.54']],
		'PHPStan\Rules\Exceptions\ThrowExpressionRule' => [['rules.55']],
		'PHPStan\Rules\Functions\ArrowFunctionAttributesRule' => [['rules.56']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule' => [['rules.57']],
		'PHPStan\Rules\Functions\ClosureAttributesRule' => [['rules.58']],
		'PHPStan\Rules\Functions\DefineParametersRule' => [['rules.59']],
		'PHPStan\Rules\Functions\ExistingClassesInArrowFunctionTypehintsRule' => [['rules.60']],
		'PHPStan\Rules\Functions\CallToFunctionParametersRule' => [['rules.61']],
		'PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule' => [['rules.62']],
		'PHPStan\Rules\Functions\ExistingClassesInTypehintsRule' => [['rules.63']],
		'PHPStan\Rules\Functions\FunctionAttributesRule' => [['rules.64']],
		'PHPStan\Rules\Functions\InnerFunctionRule' => [['rules.65']],
		'PHPStan\Rules\Functions\InvalidLexicalVariablesInClosureUseRule' => [['rules.66']],
		'PHPStan\Rules\Functions\ParamAttributesRule' => [['rules.67']],
		'PHPStan\Rules\Functions\PrintfArrayParametersRule' => [['rules.68']],
		'PHPStan\Rules\Functions\PrintfParametersRule' => [['rules.69']],
		'PHPStan\Rules\Functions\RedefinedParametersRule' => [['rules.70']],
		'PHPStan\Rules\Functions\ReturnNullsafeByRefRule' => [['rules.71']],
		'PHPStan\Rules\Ignore\IgnoreParseErrorRule' => [['rules.72']],
		'PHPStan\Rules\Functions\VariadicParametersDeclarationRule' => [['rules.73']],
		'PHPStan\Rules\Keywords\ContinueBreakInLoopRule' => [['rules.74']],
		'PHPStan\Rules\Keywords\DeclareStrictTypesRule' => [['rules.75']],
		'PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule' => [['rules.76']],
		'PHPStan\Rules\Methods\AbstractPrivateMethodRule' => [['rules.77']],
		'PHPStan\Rules\Methods\CallMethodsRule' => [['rules.78']],
		'PHPStan\Rules\Methods\CallStaticMethodsRule' => [['rules.79']],
		'PHPStan\Rules\Methods\ConsistentConstructorRule' => [['rules.80']],
		'PHPStan\Rules\Methods\ConstructorReturnTypeRule' => [['rules.81']],
		'PHPStan\Rules\Methods\ExistingClassesInTypehintsRule' => [['rules.82']],
		'PHPStan\Rules\Methods\FinalPrivateMethodRule' => [['rules.83']],
		'PHPStan\Rules\Methods\MethodCallableRule' => [['rules.84']],
		'PHPStan\Rules\Methods\MethodVisibilityInInterfaceRule' => [['rules.85']],
		'PHPStan\Rules\Methods\MissingMagicSerializationMethodsRule' => [['rules.86']],
		'PHPStan\Rules\Methods\MissingMethodImplementationRule' => [['rules.87']],
		'PHPStan\Rules\Methods\MethodAttributesRule' => [['rules.88']],
		'PHPStan\Rules\Methods\StaticMethodCallableRule' => [['rules.89']],
		'PHPStan\Rules\Names\UsedNamesRule' => [['rules.90']],
		'PHPStan\Rules\Operators\InvalidAssignVarRule' => [['rules.91']],
		'PHPStan\Rules\Operators\InvalidIncDecOperationRule' => [['rules.92']],
		'PHPStan\Rules\Properties\AccessPropertiesInAssignRule' => [['rules.93']],
		'PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule' => [['rules.94']],
		'PHPStan\Rules\Properties\ExistingClassesInPropertyHookTypehintsRule' => [['rules.95']],
		'PHPStan\Rules\Properties\InvalidCallablePropertyTypeRule' => [['rules.96']],
		'PHPStan\Rules\Properties\MissingReadOnlyPropertyAssignRule' => [['rules.97']],
		'PHPStan\Rules\Properties\MissingReadOnlyByPhpDocPropertyAssignRule' => [['rules.98']],
		'PHPStan\Rules\Properties\PropertiesInInterfaceRule' => [['rules.99']],
		'PHPStan\Rules\Properties\PropertyAssignRefRule' => [['rules.100']],
		'PHPStan\Rules\Properties\PropertyAttributesRule' => [['rules.101']],
		'PHPStan\Rules\Properties\PropertyHookAttributesRule' => [['rules.102']],
		'PHPStan\Rules\Properties\PropertyInClassRule' => [['rules.103']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyRule' => [['rules.104']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyRule' => [['rules.105']],
		'PHPStan\Rules\Regexp\RegularExpressionPatternRule' => [['rules.106']],
		'PHPStan\Rules\Traits\ConflictingTraitConstantsRule' => [['rules.107']],
		'PHPStan\Rules\Traits\ConstantsInTraitsRule' => [['rules.108']],
		'PHPStan\Rules\Traits\TraitAttributesRule' => [['rules.109']],
		'PHPStan\Rules\Types\InvalidTypesInUnionRule' => [['rules.110']],
		'PHPStan\Rules\Variables\UnsetRule' => [['rules.111']],
		'PHPStan\Rules\Whitespace\FileWhitespaceRule' => [['rules.112']],
		'PHPStan\Rules\Classes\UnusedConstructorParametersRule' => [['rules.113']],
		'PHPStan\Rules\Functions\UnusedClosureUsesRule' => [['rules.114']],
		'PHPStan\Rules\Variables\EmptyRule' => [['rules.115']],
		'PHPStan\Rules\Variables\IssetRule' => [['rules.116']],
		'PHPStan\Rules\Variables\NullCoalesceRule' => [['rules.117']],
		'PHPStan\Rules\Cast\EchoRule' => [['rules.118']],
		'PHPStan\Rules\Cast\InvalidCastRule' => [['rules.119']],
		'PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule' => [['rules.120']],
		'PHPStan\Rules\Cast\PrintRule' => [['rules.121']],
		'PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule' => [['rules.122']],
		'PHPStan\Rules\Classes\MethodTagRule' => [['rules.123']],
		'PHPStan\Rules\Classes\MethodTagTraitRule' => [['rules.124']],
		'PHPStan\Rules\Classes\MethodTagTraitUseRule' => [['rules.125']],
		'PHPStan\Rules\Classes\PropertyTagRule' => [['rules.126']],
		'PHPStan\Rules\Classes\PropertyTagTraitRule' => [['rules.127']],
		'PHPStan\Rules\Classes\PropertyTagTraitUseRule' => [['rules.128']],
		'PHPStan\Rules\Classes\MixinTraitRule' => [['rules.129']],
		'PHPStan\Rules\Classes\MixinTraitUseRule' => [['rules.130']],
		'PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule' => [['rules.131']],
		'PHPStan\Rules\Constants\ValueAssignedToClassConstantRule' => [['rules.132']],
		'PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule' => [['rules.133']],
		'PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule' => [['rules.134']],
		'PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule' => [['rules.135']],
		'PHPStan\Rules\Generics\ClassAncestorsRule' => [['rules.136']],
		'PHPStan\Rules\Generics\ClassTemplateTypeRule' => [['rules.137']],
		'PHPStan\Rules\Generics\EnumAncestorsRule' => [['rules.138']],
		'PHPStan\Rules\Generics\EnumTemplateTypeRule' => [['rules.139']],
		'PHPStan\Rules\Generics\FunctionTemplateTypeRule' => [['rules.140']],
		'PHPStan\Rules\Generics\FunctionSignatureVarianceRule' => [['rules.141']],
		'PHPStan\Rules\Generics\InterfaceAncestorsRule' => [['rules.142']],
		'PHPStan\Rules\Generics\InterfaceTemplateTypeRule' => [['rules.143']],
		'PHPStan\Rules\Generics\MethodTemplateTypeRule' => [['rules.144']],
		'PHPStan\Rules\Generics\MethodTagTemplateTypeRule' => [['rules.145']],
		'PHPStan\Rules\Generics\MethodTagTemplateTypeTraitRule' => [['rules.146']],
		'PHPStan\Rules\Generics\MethodSignatureVarianceRule' => [['rules.147']],
		'PHPStan\Rules\Generics\PropertyVarianceRule' => [['rules.148']],
		'PHPStan\Rules\Generics\TraitTemplateTypeRule' => [['rules.149']],
		'PHPStan\Rules\Generics\UsedTraitsRule' => [['rules.150']],
		'PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule' => [['rules.151']],
		'PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule' => [['rules.152']],
		'PHPStan\Rules\Operators\InvalidBinaryOperationRule' => [['rules.153']],
		'PHPStan\Rules\Operators\InvalidComparisonOperationRule' => [['rules.154']],
		'PHPStan\Rules\Operators\InvalidUnaryOperationRule' => [['rules.155']],
		'PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule' => [['rules.156']],
		'PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule' => [['rules.157']],
		'PHPStan\Rules\PhpDoc\FunctionAssertRule' => [['rules.158']],
		'PHPStan\Rules\PhpDoc\MethodAssertRule' => [['rules.159']],
		'PHPStan\Rules\PhpDoc\IncompatibleSelfOutTypeRule' => [['rules.160']],
		'PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule' => [['rules.161']],
		'PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule' => [['rules.162']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyHookPhpDocTypeRule' => [['rules.163']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule' => [['rules.164']],
		'PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule' => [['rules.165']],
		'PHPStan\Rules\PhpDoc\IncompatibleParamImmediatelyInvokedCallableRule' => [['rules.166']],
		'PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule' => [['rules.167']],
		'PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule' => [['rules.168']],
		'PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule' => [['rules.169']],
		'PHPStan\Rules\Classes\RequireImplementsRule' => [['rules.170']],
		'PHPStan\Rules\Classes\RequireExtendsRule' => [['rules.171']],
		'PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule' => [['rules.172']],
		'PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule' => [['rules.173']],
		'PHPStan\Rules\PhpDoc\RequireExtendsDefinitionTraitRule' => [['rules.174']],
		'PHPStan\Rules\Pure\PureFunctionRule' => [['rules.175']],
		'PHPStan\Rules\Pure\PureMethodRule' => [['rules.176']],
		'PHPStan\Rules\Arrays\ArrayDestructuringRule' => [['rules.177']],
		'PHPStan\Rules\Arrays\ArrayUnpackingRule' => [['rules.178']],
		'PHPStan\Rules\Arrays\IterableInForeachRule' => [['rules.179']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignmentRule' => [['rules.180']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignOpRule' => [['rules.181']],
		'PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule' => [['rules.182']],
		'PHPStan\Rules\Arrays\UnpackIterableInArrayRule' => [['rules.183']],
		'PHPStan\Rules\Exceptions\ThrowExprTypeRule' => [['rules.184']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule' => [['rules.185']],
		'PHPStan\Rules\Functions\ClosureReturnTypeRule' => [['rules.186']],
		'PHPStan\Rules\Functions\ReturnTypeRule' => [['rules.187']],
		'PHPStan\Rules\Generators\YieldTypeRule' => [['rules.188']],
		'PHPStan\Rules\Methods\ReturnTypeRule' => [['rules.189']],
		'PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule' => [['rules.190']],
		'PHPStan\Rules\Properties\GetNonVirtualPropertyHookReadRule' => [['rules.191']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule' => [['rules.192']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule' => [['rules.193']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule' => [['rules.194']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule' => [['rules.195']],
		'PHPStan\Rules\Properties\SetNonVirtualPropertyHookAssignRule' => [['rules.196']],
		'PHPStan\Rules\Properties\TypesAssignedToPropertiesRule' => [['rules.197']],
		'PHPStan\Rules\Variables\ParameterOutAssignedTypeRule' => [['rules.198']],
		'PHPStan\Rules\Variables\ParameterOutExecutionEndTypeRule' => [['rules.199']],
		'PHPStan\Rules\Variables\VariableCloningRule' => [['rules.200']],
		'PHPStan\Rules\Arrays\DeadForeachRule' => [['rules.201']],
		'PHPStan\Rules\DeadCode\CallToConstructorStatementWithoutImpurePointsRule' => [['rules.202']],
		'PHPStan\Rules\DeadCode\CallToFunctionStatementWithoutImpurePointsRule' => [['rules.203']],
		'PHPStan\Rules\DeadCode\CallToMethodStatementWithoutImpurePointsRule' => [['rules.204']],
		'PHPStan\Rules\DeadCode\CallToStaticMethodStatementWithoutImpurePointsRule' => [['rules.205']],
		'PHPStan\Rules\DeadCode\NoopRule' => [['rules.206']],
		'PHPStan\Rules\DeadCode\UnreachableStatementRule' => [['rules.207']],
		'PHPStan\Rules\DeadCode\UnusedPrivateConstantRule' => [['rules.208']],
		'PHPStan\Rules\DeadCode\UnusedPrivateMethodRule' => [['rules.209']],
		'PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule' => [['rules.210']],
		'PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule' => [['rules.211']],
		'PHPStan\Rules\Functions\UselessFunctionReturnValueRule' => [['rules.212']],
		'PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule' => [['rules.213']],
		'PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule' => [['rules.214']],
		'PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule' => [['rules.215']],
		'PHPStan\Rules\Methods\NullsafeMethodCallRule' => [['rules.216']],
		'PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule' => [['rules.217']],
		'PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule' => [['rules.218']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule' => [['rules.219']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionParameterOutTypeRule' => [['rules.220']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodParameterOutTypeRule' => [['rules.221']],
		'PHPStan\Rules\TooWideTypehints\TooWidePropertyTypeRule' => [['rules.222']],
		'PHPStan\Rules\Traits\NotAnalysedTraitRule' => [['rules.223']],
		'PHPStan\Rules\DateTimeInstantiationRule' => [['rules.224']],
		'PHPStan\Rules\Functions\CallUserFuncRule' => [['rules.225']],
		'PHPStan\Rules\Functions\ParameterCastableToStringRule' => [['rules.226']],
		'PHPStan\Rules\Functions\ImplodeParameterCastableToStringRule' => [['rules.227']],
		'PHPStan\Rules\Functions\SortParameterCastableToStringRule' => [['rules.228']],
		'PHPStan\Rules\Regexp\RegularExpressionQuotingRule' => [['rules.229']],
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.230']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['rules.231']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.232']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['rules.233']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [['rules.234']],
		'PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule' => [['rules.235']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [['rules.236']],
		'Larastan\Larastan\Rules\UselessConstructs\NoUselessWithFunctionCallsRule' => [['rules.237']],
		'Larastan\Larastan\Rules\UselessConstructs\NoUselessValueFunctionCallsRule' => [['rules.238']],
		'Larastan\Larastan\Rules\DeferrableServiceProviderMissingProvidesRule' => [['rules.239']],
		'Larastan\Larastan\Rules\ConsoleCommand\UndefinedArgumentOrOptionRule' => [['rules.240']],
		...
		'PHPStan\PhpDoc\StubFilesExtension' => [['044', '046', '047', '048', '0531']],
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [
			['098', '0112', '0114', '0115', '0119', '0285', '0463', '0464', '0465', '0471'],
		],
		...
		'PHPStan\Type\Php\ArrayColumnFunctionReturnTypeExtension' => [['0194']],
		'PHPStan\Type\Php\ArrayCombineFunctionReturnTypeExtension' => [['0195']],
		'PHPStan\Type\Php\ArrayCurrentDynamicReturnTypeExtension' => [['0196']],
		'PHPStan\Type\Php\ArrayFillFunctionReturnTypeExtension' => [['0197']],
		'PHPStan\Type\Php\ArrayFillKeysFunctionReturnTypeExtension' => [['0198']],
		'PHPStan\Type\Php\ArrayFilterFunctionReturnTypeHelper' => [['0199']],
		'PHPStan\Type\Php\ArrayFilterFunctionReturnTypeExtension' => [['0200']],
		'PHPStan\Type\Php\ArrayFlipFunctionReturnTypeExtension' => [['0201']],
		'PHPStan\Type\Php\ArrayFindFunctionReturnTypeExtension' => [['0202']],
		'PHPStan\Type\Php\ArrayFindKeyFunctionReturnTypeExtension' => [['0203']],
		'PHPStan\Type\Php\ArrayKeyDynamicReturnTypeExtension' => [['0204']],
		...
		'PHPStan\Type\Php\ArrayKeyExistsFunctionTypeSpecifyingExtension' => [['0205']],
		'PHPStan\Type\Php\ArrayKeyFirstDynamicReturnTypeExtension' => [['0206']],
		'PHPStan\Type\Php\ArrayKeyLastDynamicReturnTypeExtension' => [['0207']],
		'PHPStan\Type\Php\ArrayKeysFunctionDynamicReturnTypeExtension' => [['0208']],
		'PHPStan\Type\Php\ArrayMapFunctionReturnTypeExtension' => [['0209']],
		'PHPStan\Type\Php\ArrayMergeFunctionDynamicReturnTypeExtension' => [['0210']],
		'PHPStan\Type\Php\ArrayNextDynamicReturnTypeExtension' => [['0211']],
		'PHPStan\Type\Php\ArrayPopFunctionReturnTypeExtension' => [['0212']],
		'PHPStan\Type\Php\ArrayRandFunctionReturnTypeExtension' => [['0213']],
		'PHPStan\Type\Php\ArrayReduceFunctionReturnTypeExtension' => [['0214']],
		'PHPStan\Type\Php\ArrayReplaceFunctionReturnTypeExtension' => [['0215']],
		'PHPStan\Type\Php\ArrayReverseFunctionReturnTypeExtension' => [['0216']],
		'PHPStan\Type\Php\ArrayShiftFunctionReturnTypeExtension' => [['0217']],
		'PHPStan\Type\Php\ArraySliceFunctionReturnTypeExtension' => [['0218']],
		...
		'PHPStan\Type\Php\ArraySearchFunctionTypeSpecifyingExtension' => [['0221']],
		'PHPStan\Type\Php\ArrayValuesFunctionDynamicReturnTypeExtension' => [['0222']],
		'PHPStan\Type\Php\ArraySumFunctionDynamicReturnTypeExtension' => [['0223']],
		'PHPStan\Type\DynamicFunctionThrowTypeExtension' => [['0224', '0269', '0271']],
		'PHPStan\Type\Php\AssertThrowTypeExtension' => [['0224']],
		...
		'PHPStan\Type\Php\BackedEnumFromMethodDynamicReturnTypeExtension' => [['0225']],
		'PHPStan\Type\Php\Base64DecodeDynamicFunctionReturnTypeExtension' => [['0226']],
		'PHPStan\Type\Php\BcMathStringOrNullReturnTypeExtension' => [['0227']],
		'PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension' => [['0228']],
		'PHPStan\Type\Php\ClosureBindToDynamicReturnTypeExtension' => [['0229']],
		'PHPStan\Type\Php\ClosureFromCallableDynamicReturnTypeExtension' => [['0230']],
		'PHPStan\Type\Php\CompactFunctionReturnTypeExtension' => [['0231']],
		'PHPStan\Type\Php\ConstantFunctionReturnTypeExtension' => [['0232']],
		'PHPStan\Type\Php\ConstantHelper' => [['0233']],
		'PHPStan\Type\Php\CountFunctionReturnTypeExtension' => [['0234']],
		'PHPStan\Type\Php\CountCharsFunctionDynamicReturnTypeExtension' => [['0235']],
		'PHPStan\Type\Php\CountFunctionTypeSpecifyingExtension' => [['0236']],
		'PHPStan\Type\Php\CurlGetinfoFunctionDynamicReturnTypeExtension' => [['0237']],
		'PHPStan\Type\Php\DateFunctionReturnTypeHelper' => [['0238']],
		'PHPStan\Type\Php\DateFormatFunctionReturnTypeExtension' => [['0239']],
		'PHPStan\Type\Php\DateFormatMethodReturnTypeExtension' => [['0240']],
		'PHPStan\Type\Php\DateFunctionReturnTypeExtension' => [['0241']],
		'PHPStan\Type\DynamicStaticMethodThrowTypeExtension' => [
			['0242', '0248', '0251', '0280', '0281', '0282', '0283', '0286'],
		],
		'PHPStan\Type\Php\DateIntervalConstructorThrowTypeExtension' => [['0242']],
		'PHPStan\Type\Php\DateIntervalDynamicReturnTypeExtension' => [['0243']],
		'PHPStan\Type\Php\DateTimeCreateDynamicReturnTypeExtension' => [['0244']],
		'PHPStan\Type\Php\DateTimeDynamicReturnTypeExtension' => [['0245']],
		'PHPStan\Type\Php\DateTimeModifyReturnTypeExtension' => [['0246', '0247']],
		'PHPStan\Type\Php\DateTimeConstructorThrowTypeExtension' => [['0248']],
		'PHPStan\Type\DynamicMethodThrowTypeExtension' => [['0249', '0250', '0253']],
		'PHPStan\Type\Php\DateTimeModifyMethodThrowTypeExtension' => [['0249']],
		'PHPStan\Type\Php\DateTimeSubMethodThrowTypeExtension' => [['0250']],
		'PHPStan\Type\Php\DateTimeZoneConstructorThrowTypeExtension' => [['0251']],
		'PHPStan\Type\Php\DsMapDynamicReturnTypeExtension' => [['0252']],
		'PHPStan\Type\Php\DsMapDynamicMethodThrowTypeExtension' => [['0253']],
		'PHPStan\Type\Php\DioStatDynamicFunctionReturnTypeExtension' => [['0254']],
		'PHPStan\Type\Php\ExplodeFunctionDynamicReturnTypeExtension' => [['0255']],
		'PHPStan\Type\Php\FilterFunctionReturnTypeHelper' => [['0256']],
		'PHPStan\Type\Php\FilterInputDynamicReturnTypeExtension' => [['0257']],
		'PHPStan\Type\Php\FilterVarDynamicReturnTypeExtension' => [['0258']],
		'PHPStan\Type\Php\FilterVarArrayDynamicReturnTypeExtension' => [['0259']],
		'PHPStan\Type\Php\GetCalledClassDynamicReturnTypeExtension' => [['0260']],
		'PHPStan\Type\Php\GetClassDynamicReturnTypeExtension' => [['0261']],
		'PHPStan\Type\Php\GetDebugTypeFunctionReturnTypeExtension' => [['0262']],
		'PHPStan\Type\Php\GetDefinedVarsFunctionReturnTypeExtension' => [['0263']],
		'PHPStan\Type\Php\GetParentClassDynamicFunctionReturnTypeExtension' => [['0264']],
		'PHPStan\Type\Php\GettypeFunctionReturnTypeExtension' => [['0265']],
		'PHPStan\Type\Php\GettimeofdayDynamicFunctionReturnTypeExtension' => [['0266']],
		'PHPStan\Type\Php\HashFunctionsReturnTypeExtension' => [['0267']],
		'PHPStan\Type\Php\HighlightStringDynamicReturnTypeExtension' => [['0268']],
		'PHPStan\Type\Php\IntdivThrowTypeExtension' => [['0269']],
		'PHPStan\Type\Php\IniGetReturnTypeExtension' => [['0270']],
		'PHPStan\Type\Php\JsonThrowTypeExtension' => [['0271']],
		'PHPStan\Type\FunctionParameterOutTypeExtension' => [['0272', '0273', '0275']],
		'PHPStan\Type\Php\OpenSslEncryptParameterOutTypeExtension' => [['0272']],
		'PHPStan\Type\Php\ParseStrParameterOutTypeExtension' => [['0273']],
		'PHPStan\Type\Php\PregMatchTypeSpecifyingExtension' => [['0274']],
		'PHPStan\Type\Php\PregMatchParameterOutTypeExtension' => [['0275']],
		'PHPStan\Type\FunctionParameterClosureTypeExtension' => [['0276']],
		'PHPStan\Type\Php\PregReplaceCallbackClosureTypeExtension' => [['0276']],
		'PHPStan\Type\Php\RegexArrayShapeMatcher' => [['0277']],
		'PHPStan\Type\Regex\RegexGroupParser' => [['0278']],
		'PHPStan\Type\Regex\RegexExpressionHelper' => [['0279']],
		'PHPStan\Type\Php\ReflectionClassConstructorThrowTypeExtension' => [['0280']],
		'PHPStan\Type\Php\ReflectionFunctionConstructorThrowTypeExtension' => [['0281']],
		'PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension' => [['0282']],
		'PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension' => [['0283']],
		'PHPStan\Type\Php\StrContainingTypeSpecifyingExtension' => [['0284']],
		'PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension' => [['0285']],
		'PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension' => [['0286']],
		'PHPStan\Type\Php\StatDynamicReturnTypeExtension' => [['0287']],
		'PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension' => [['0288']],
		'PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension' => [['0289']],
		'PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension' => [['0290']],
		'PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension' => [['0291']],
		'PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension' => [['0292']],
		'PHPStan\Type\Php\PregFilterFunctionReturnTypeExtension' => [['0293']],
		'PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension' => [['0294']],
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0295']],
		'PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension' => [['0295']],
		'PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension' => [['0296']],
		'PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension' => [['0297']],
		'PHPStan\Type\Php\LtrimFunctionReturnTypeExtension' => [['0298']],
		'PHPStan\Type\Php\MbFunctionsReturnTypeExtension' => [['0299']],
		'PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension' => [['0300']],
		'PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension' => [['0301']],
		'PHPStan\Type\Php\MbStrlenFunctionReturnTypeExtension' => [['0302']],
		'PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension' => [['0303']],
		'PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension' => [['0304']],
		'PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension' => [['0305']],
		'PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension' => [['0306']],
		'PHPStan\Type\Php\SetTypeFunctionTypeSpecifyingExtension' => [['0307']],
		'PHPStan\Type\Php\StrCaseFunctionsReturnTypeExtension' => [['0308']],
		'PHPStan\Type\Php\StrlenFunctionReturnTypeExtension' => [['0309']],
		'PHPStan\Type\Php\StrIncrementDecrementFunctionReturnTypeExtension' => [['0310']],
		'PHPStan\Type\Php\StrPadFunctionReturnTypeExtension' => [['0311']],
		'PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension' => [['0312']],
		'PHPStan\Type\Php\SubstrDynamicReturnTypeExtension' => [['0313']],
		'PHPStan\Type\Php\ThrowableReturnTypeExtension' => [['0314']],
		'PHPStan\Type\Php\ParseUrlFunctionDynamicReturnTypeExtension' => [['0315']],
		'PHPStan\Type\Php\TriggerErrorDynamicReturnTypeExtension' => [['0316']],
		'PHPStan\Type\Php\TrimFunctionDynamicReturnTypeExtension' => [['0317']],
		'PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension' => [['0318']],
		'PHPStan\Type\Php\PowFunctionReturnTypeExtension' => [['0319']],
		'PHPStan\Type\Php\RoundFunctionReturnTypeExtension' => [['0320']],
		'PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension' => [['0321']],
		'PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension' => [['0322']],
		'PHPStan\Type\Php\RangeFunctionReturnTypeExtension' => [['0323']],
		'PHPStan\Type\Php\AssertFunctionTypeSpecifyingExtension' => [['0324']],
		'PHPStan\Type\Php\ClassExistsFunctionTypeSpecifyingExtension' => [['0325']],
		'PHPStan\Type\Php\ClassImplementsFunctionReturnTypeExtension' => [['0326']],
		'PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension' => [['0327']],
		'PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension' => [['0328']],
		'PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension' => [['0329']],
		'PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension' => [['0330']],
		'PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension' => [['0331']],
		'PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension' => [['0332']],
		'PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension' => [['0333']],
		'PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension' => [['0334']],
		'PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension' => [['0335']],
		'PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension' => [['0336']],
		'PHPStan\Type\Php\IsAFunctionTypeSpecifyingHelper' => [['0337']],
		'PHPStan\Type\Php\CtypeDigitFunctionTypeSpecifyingExtension' => [['0338']],
		'PHPStan\Type\Php\JsonThrowOnErrorDynamicReturnTypeExtension' => [['0339']],
		'PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension' => [['0340']],
		'PHPStan\Type\Php\SimpleXMLElementAsXMLMethodReturnTypeExtension' => [['0341']],
		'PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension' => [['0342']],
		'PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension' => [['0343']],
		'PHPStan\Type\Php\StrTokFunctionReturnTypeExtension' => [['0344']],
		'PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension' => [['0345']],
		'PHPStan\Type\Php\SscanfFunctionDynamicReturnTypeExtension' => [['0346']],
		'PHPStan\Type\Php\StrvalFamilyFunctionReturnTypeExtension' => [['0347']],
		'PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension' => [['0348']],
		'PHPStan\Type\Php\XMLReaderOpenReturnTypeExtension' => [['0349']],
		'PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension' => [['0350', '0351', '0352', '0353', '0354']],
		'PHPStan\Type\Php\DatePeriodConstructorReturnTypeExtension' => [['0355']],
		'PHPStan\Type\PHPStan\ClassNameUsageLocationCreateIdentifierDynamicReturnTypeExtension' => [['0356']],
		'PHPStan\Type\ClosureTypeFactory' => [['0357']],
		'PHPStan\Type\Constant\OversizedArrayBuilder' => [['0358']],
		'PHPStan\Rules\Functions\PrintfHelper' => [['0359']],
		...
		'PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory' => [['0360']],
		'PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory' => [['0361']],
		'PHPStan\Reflection\BetterReflection\SourceStubber\PhpStormStubsSourceStubberFactory' => [['0362']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\SourceStubber' => [1 => ['0363', '0364']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber' => [['0363']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber' => [['0364']],
		'PHPStan\Reflection\BetterReflection\SourceStubber\ReflectionSourceStubberFactory' => [['0365']],
		'PHPStan\Reflection\Deprecation\DeprecationProvider' => [['0366']],
		...
		'PHPStan\Command\ErrorFormatter\CiDetectedErrorFormatter' => [['0367']],
		...
		'PHPStan\Rules\Classes\ExistingClassInClassExtendsRule' => [['0368']],
		'PHPStan\Rules\Classes\ExistingClassesInClassImplementsRule' => [['0369']],
		'PHPStan\Rules\Classes\ExistingClassesInEnumImplementsRule' => [['0370']],
		'PHPStan\Rules\Classes\ExistingClassInInstanceOfRule' => [['0371']],
		'PHPStan\Rules\Classes\ExistingClassesInInterfaceExtendsRule' => [['0372']],
		'PHPStan\Rules\Classes\ExistingClassInTraitUseRule' => [['0373']],
		'PHPStan\Rules\Classes\InstantiationRule' => [['0374']],
		'PHPStan\Rules\Exceptions\CaughtExceptionExistenceRule' => [['0375']],
		'PHPStan\Rules\Functions\CallToNonExistentFunctionRule' => [['0376']],
		'PHPStan\Rules\Constants\OverridingConstantRule' => [['0377']],
		'PHPStan\Rules\Methods\OverridingMethodRule' => [['0378']],
		'PHPStan\Rules\Missing\MissingReturnRule' => [['0379']],
		'PHPStan\Rules\Namespaces\ExistingNamesInGroupUseRule' => [['0380']],
		'PHPStan\Rules\Namespaces\ExistingNamesInUseRule' => [['0381']],
		'PHPStan\Rules\Properties\AccessPropertiesRule' => [['0382']],
		'PHPStan\Rules\Properties\AccessStaticPropertiesRule' => [['0383']],
		'PHPStan\Rules\Properties\ExistingClassesInPropertiesRule' => [['0384']],
		'PHPStan\Rules\Functions\FunctionCallableRule' => [['0385']],
		'PHPStan\Rules\Properties\OverridingPropertyRule' => [['0386']],
		'PHPStan\Rules\Properties\SetPropertyHookParameterRule' => [['0387']],
		'PHPStan\Rules\Properties\WritingToReadOnlyPropertiesRule' => [['0388']],
		'PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule' => [['0389']],
		'PHPStan\Rules\Variables\CompactVariablesRule' => [['0390']],
		'PHPStan\Rules\Variables\DefinedVariableRule' => [['0391']],
		'PHPStan\Rules\Keywords\RequireFileExistsRule' => [['0392']],
		'PHPStan\Rules\RestrictedUsage\RestrictedClassConstantUsageExtension' => [['0393']],
		'PHPStan\Rules\InternalTag\RestrictedInternalClassConstantUsageExtension' => [['0393']],
		'PHPStan\Rules\RestrictedUsage\RestrictedClassNameUsageExtension' => [['0394']],
		'PHPStan\Rules\InternalTag\RestrictedInternalClassNameUsageExtension' => [['0394']],
		'PHPStan\Rules\RestrictedUsage\RestrictedFunctionUsageExtension' => [['0395']],
		'PHPStan\Rules\InternalTag\RestrictedInternalFunctionUsageExtension' => [['0395']],
		'PHPStan\Rules\Constants\ConstantRule' => [['0396']],
		'PHPStan\Rules\Classes\MixinRule' => [['0397']],
		'PHPStan\Rules\PhpDoc\RequireExtendsCheck' => [['0398']],
		'PHPStan\Rules\PhpDoc\RequireImplementsDefinitionTraitRule' => [['0399']],
		'PHPStan\Rules\Functions\CallCallablesRule' => [['0400']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule' => [['0401']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule' => [['0402']],
		'PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule' => [['0403']],
		'PHPStan\Rules\RestrictedUsage\RestrictedPropertyUsageExtension' => [['0404']],
		'PHPStan\Rules\InternalTag\RestrictedInternalPropertyUsageExtension' => [['0404']],
		'PHPStan\Rules\RestrictedUsage\RestrictedMethodUsageExtension' => [['0405']],
		'PHPStan\Rules\InternalTag\RestrictedInternalMethodUsageExtension' => [['0405']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule' => [['0406']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule' => [['0407']],
		'PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule' => [['0408']],
		'PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule' => [['0409']],
		'PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule' => [['0410']],
		'PHPStan\Rules\Exceptions\ThrowsVoidPropertyHookWithExplicitThrowPointRule' => [['0411']],
		'PHPStan\Rules\Generators\YieldFromTypeRule' => [['0412']],
		'PHPStan\Rules\Generators\YieldInGeneratorRule' => [['0413']],
		'PHPStan\Rules\Classes\ImpossibleInstanceOfRule' => [['0414']],
		'PHPStan\Rules\Comparison\BooleanAndConstantConditionRule' => [['0415']],
		'PHPStan\Rules\Comparison\BooleanOrConstantConditionRule' => [['0416']],
		...
		'PHPStan\Rules\DeadCode\ConstructorWithoutImpurePointsCollector' => [['0418']],
		'PHPStan\Rules\DeadCode\PossiblyPureNewCollector' => [['0419']],
		'PHPStan\Rules\DeadCode\FunctionWithoutImpurePointsCollector' => [['0420']],
		'PHPStan\Rules\DeadCode\PossiblyPureFuncCallCollector' => [['0421']],
		'PHPStan\Rules\DeadCode\MethodWithoutImpurePointsCollector' => [['0422']],
		'PHPStan\Rules\DeadCode\PossiblyPureMethodCallCollector' => [['0423']],
		'PHPStan\Rules\DeadCode\PossiblyPureStaticCallCollector' => [['0424']],
		'PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule' => [['0425']],
		'PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule' => [['0426']],
		'PHPStan\Rules\Comparison\ElseIfConstantConditionRule' => [['0427']],
		'PHPStan\Rules\Comparison\IfConstantConditionRule' => [['0428']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule' => [['0429']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule' => [['0430']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule' => [['0431']],
		'PHPStan\Rules\Comparison\LogicalXorConstantConditionRule' => [['0432']],
		...
		'PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule' => [['0438']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule' => [['0439']],
		'PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule' => [['0440']],
		'PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule' => [['0441']],
		'PHPStan\Rules\Exceptions\TooWidePropertyHookThrowTypeRule' => [['0442']],
		...
		'PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule' => [['0447']],
		'PHPStan\Rules\Functions\RandomIntParametersRule' => [['0448']],
		'PHPStan\Rules\Functions\ArrayFilterRule' => [['0449']],
		'PHPStan\Rules\Functions\ArrayValuesRule' => [['0450']],
		'PHPStan\Rules\Functions\ParameterCastableToNumberRule' => [['0451']],
		'Larastan\Larastan\Methods\RelationForwardsCallsExtension' => [['0452']],
		'Larastan\Larastan\Methods\ModelForwardsCallsExtension' => [['0453']],
		'Larastan\Larastan\Methods\EloquentBuilderForwardsCallsExtension' => [['0454']],
		'Larastan\Larastan\Methods\HigherOrderTapProxyExtension' => [['0455']],
		'Larastan\Larastan\Methods\HigherOrderCollectionProxyExtension' => [['0456']],
		'Larastan\Larastan\Methods\StorageMethodsClassReflectionExtension' => [['0457']],
		'Larastan\Larastan\Methods\Extension' => [['0458']],
		'Larastan\Larastan\Methods\ModelFactoryMethodsClassReflectionExtension' => [['0459']],
		'Larastan\Larastan\Methods\RedirectResponseMethodsClassReflectionExtension' => [['0460']],
		'Larastan\Larastan\Methods\MacroMethodsClassReflectionExtension' => [['0461']],
		'Larastan\Larastan\Methods\ViewWithMethodsClassReflectionExtension' => [['0462']],
		'Larastan\Larastan\Properties\ModelAccessorExtension' => [['0463']],
		'Larastan\Larastan\Properties\ModelPropertyExtension' => [['0464']],
		'Larastan\Larastan\Properties\HigherOrderCollectionProxyPropertyExtension' => [['0465']],
		'Larastan\Larastan\ReturnTypes\HigherOrderTapProxyExtension' => [['0466']],
		'Larastan\Larastan\ReturnTypes\ContainerArrayAccessDynamicMethodReturnTypeExtension' => [
			['0467', '0468', '0469', '0470'],
		],
		'Larastan\Larastan\Properties\ModelRelationsExtension' => [['0471']],
		'Larastan\Larastan\ReturnTypes\ModelOnlyDynamicMethodReturnTypeExtension' => [['0472']],
		'Larastan\Larastan\ReturnTypes\ModelFactoryDynamicStaticMethodReturnTypeExtension' => [['0473']],
		'Larastan\Larastan\ReturnTypes\ModelDynamicStaticMethodReturnTypeExtension' => [['0474']],
		'Larastan\Larastan\ReturnTypes\AppMakeDynamicReturnTypeExtension' => [['0475']],
		'Larastan\Larastan\ReturnTypes\AuthExtension' => [['0476']],
		'Larastan\Larastan\ReturnTypes\GuardDynamicStaticMethodReturnTypeExtension' => [['0477']],
		'Larastan\Larastan\ReturnTypes\AuthManagerExtension' => [['0478']],
		'Larastan\Larastan\ReturnTypes\DateExtension' => [['0479']],
		'Larastan\Larastan\ReturnTypes\GuardExtension' => [['0480']],
		'Larastan\Larastan\ReturnTypes\RequestFileExtension' => [['0481']],
		'Larastan\Larastan\ReturnTypes\RequestRouteExtension' => [['0482']],
		'Larastan\Larastan\ReturnTypes\RequestUserExtension' => [['0483']],
		'Larastan\Larastan\ReturnTypes\EloquentBuilderExtension' => [['0484']],
		'Larastan\Larastan\ReturnTypes\RelationCollectionExtension' => [['0485']],
		'Larastan\Larastan\ReturnTypes\ModelFindExtension' => [['0486']],
		'Larastan\Larastan\ReturnTypes\BuilderModelFindExtension' => [['0487']],
		'Larastan\Larastan\ReturnTypes\TestCaseExtension' => [['0488']],
		'Larastan\Larastan\Support\CollectionHelper' => [['0489']],
		'Larastan\Larastan\ReturnTypes\Helpers\AuthExtension' => [['0490']],
		'Larastan\Larastan\ReturnTypes\Helpers\CollectExtension' => [['0491']],
		'Larastan\Larastan\ReturnTypes\Helpers\NowAndTodayExtension' => [['0492']],
		'Larastan\Larastan\ReturnTypes\Helpers\ResponseExtension' => [['0493']],
		'Larastan\Larastan\ReturnTypes\Helpers\ValidatorExtension' => [['0494']],
		'Larastan\Larastan\ReturnTypes\Helpers\LiteralExtension' => [['0495']],
		'Larastan\Larastan\ReturnTypes\CollectionFilterRejectDynamicReturnTypeExtension' => [['0496']],
		'Larastan\Larastan\ReturnTypes\CollectionWhereNotNullDynamicReturnTypeExtension' => [['0497']],
		'Larastan\Larastan\ReturnTypes\NewModelQueryDynamicMethodReturnTypeExtension' => [['0498']],
		'Larastan\Larastan\ReturnTypes\FactoryDynamicMethodReturnTypeExtension' => [['0499']],
		'Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension' => [['0500', '0501', '0502', '0503']],
		'Larastan\Larastan\ReturnTypes\Helpers\AppExtension' => [['0504']],
		'Larastan\Larastan\ReturnTypes\Helpers\ValueExtension' => [['0505']],
		'Larastan\Larastan\ReturnTypes\Helpers\StrExtension' => [['0506']],
		'Larastan\Larastan\ReturnTypes\Helpers\TapExtension' => [['0507']],
		'Larastan\Larastan\ReturnTypes\StorageDynamicStaticMethodReturnTypeExtension' => [['0508']],
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0509', '0510', '0516', '0520']],
		'Larastan\Larastan\Types\GenericEloquentCollectionTypeNodeResolverExtension' => [['0509']],
		'Larastan\Larastan\Types\ViewStringTypeNodeResolverExtension' => [['0510']],
		'Larastan\Larastan\Rules\OctaneCompatibilityRule' => [['0511']],
		'Larastan\Larastan\Rules\NoEnvCallsOutsideOfConfigRule' => [['0512']],
		'Larastan\Larastan\Rules\NoModelMakeRule' => [['0513']],
		'Larastan\Larastan\Rules\NoUnnecessaryCollectionCallRule' => [['0514']],
		'Larastan\Larastan\Rules\ModelAppendsRule' => [['0515']],
		'Larastan\Larastan\Types\GenericEloquentBuilderTypeNodeResolverExtension' => [['0516']],
		'Larastan\Larastan\ReturnTypes\AppEnvironmentReturnTypeExtension' => [['0517', '0518']],
		'Larastan\Larastan\ReturnTypes\AppFacadeEnvironmentReturnTypeExtension' => [['0519']],
		'Larastan\Larastan\Types\ModelProperty\ModelPropertyTypeNodeResolverExtension' => [['0520']],
		'Larastan\Larastan\Properties\MigrationHelper' => [['0521']],
		'Larastan\Larastan\Properties\SquashedMigrationHelper' => [['0522']],
		'Larastan\Larastan\Properties\ModelCastHelper' => [['0523']],
		'Larastan\Larastan\Properties\ModelPropertyHelper' => [['0524']],
		'Larastan\Larastan\Rules\ModelRuleHelper' => [['0525']],
		'Larastan\Larastan\Methods\BuilderHelper' => [['0526']],
		'Larastan\Larastan\Rules\RelationExistenceRule' => [['0527']],
		'Larastan\Larastan\Rules\CheckDispatchArgumentTypesCompatibleWithClassConstructorRule' => [['0528', '0529']],
		'Larastan\Larastan\Properties\Schema\MySqlDataTypeToPhpTypeConverter' => [['0530']],
		'Larastan\Larastan\LarastanStubFilesExtension' => [['0531']],
		'Larastan\Larastan\Rules\UnusedViewsRule' => [['0532']],
		'Larastan\Larastan\Collectors\UsedViewFunctionCollector' => [['0533']],
		'Larastan\Larastan\Collectors\UsedEmailViewCollector' => [['0534']],
		'Larastan\Larastan\Collectors\UsedViewMakeCollector' => [['0535']],
		'Larastan\Larastan\Collectors\UsedViewFacadeMakeCollector' => [['0536']],
		'Larastan\Larastan\Collectors\UsedRouteFacadeViewCollector' => [['0537']],
		'Larastan\Larastan\Collectors\UsedViewInAnotherViewCollector' => [['0538']],
		'Larastan\Larastan\Support\ViewFileHelper' => [['0539']],
		'Larastan\Larastan\ReturnTypes\ApplicationMakeDynamicReturnTypeExtension' => [['0540']],
		'Larastan\Larastan\ReturnTypes\ContainerMakeDynamicReturnTypeExtension' => [['0541']],
		'Larastan\Larastan\ReturnTypes\ConsoleCommand\ArgumentDynamicReturnTypeExtension' => [['0542']],
		'Larastan\Larastan\ReturnTypes\ConsoleCommand\HasArgumentDynamicReturnTypeExtension' => [['0543']],
		'Larastan\Larastan\ReturnTypes\ConsoleCommand\OptionDynamicReturnTypeExtension' => [['0544']],
		'Larastan\Larastan\ReturnTypes\ConsoleCommand\HasOptionDynamicReturnTypeExtension' => [['0545']],
		'Larastan\Larastan\ReturnTypes\TranslatorGetReturnTypeExtension' => [['0546']],
		'Larastan\Larastan\ReturnTypes\LangGetReturnTypeExtension' => [['0547']],
		'Larastan\Larastan\ReturnTypes\TransHelperReturnTypeExtension' => [['0548']],
		'Larastan\Larastan\ReturnTypes\DoubleUnderscoreHelperReturnTypeExtension' => [['0549']],
		'Larastan\Larastan\ReturnTypes\AppMakeHelper' => [['0550']],
		'Larastan\Larastan\Internal\ConsoleApplicationResolver' => [['0551']],
		'Larastan\Larastan\Internal\ConsoleApplicationHelper' => [['0552']],
		'Larastan\Larastan\Support\HigherOrderCollectionProxyHelper' => [['0553']],
		'Larastan\Larastan\ReturnTypes\Helpers\ConfigFunctionDynamicFunctionReturnTypeExtension' => [['0554']],
		'Larastan\Larastan\ReturnTypes\ConfigGetDynamicMethodReturnTypeExtension' => [['0555']],
		'Larastan\Larastan\Support\ConfigParser' => [['0556']],
		'Larastan\Larastan\ReturnTypes\Helpers\EnvFunctionDynamicFunctionReturnTypeExtension' => [['0557']],
		'Larastan\Larastan\ReturnTypes\FormRequestSafeDynamicMethodReturnTypeExtension' => [['0558']],
	];
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/Users/mantum/Documents/test-paypal']);
	}


	public function createService029(): PHPStan\Php\ComposerPhpVersionFactory
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/Users/mantum/Documents/test-paypal']);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('075'),
			[
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/Countable.stub',
			],
			['/Users/mantum/Documents/test-paypal']
		);
	}
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_5126a765a5 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/Users/mantum/Documents/test-paypal/.phpstan-cache/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['/Users/mantum/Documents/test-paypal'],
					'8',
					null,
					[
						'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
						'/Users/mantum/Documents/test-paypal/vendor/nunomaduro/larastan/bootstrap.php',
					],
					[],
					[],
					false,
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/Users/mantum/Documents/test-paypal/.phpstan-cache/resultCache.php');
	}
	...
	public function createService070(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/Users/mantum/Documents/test-paypal'],
			[
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/Users/mantum/Documents/test-paypal/phpstan.neon',
				'/Users/mantum/Documents/test-paypal/vendor/nunomaduro/larastan/extension.neon',
			],
			null,
			[
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService077(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/Users/mantum/Documents/test-paypal',
			'/Users/mantum/Documents/test-paypal/.phpstan-cache',
			[
				'phar:///Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'/Users/mantum/Documents/test-paypal/phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('/Users/mantum/Documents/test-paypal');
	}
	...
	{
		return new PHPStan\Parallel\ParallelAnalyser(50, 1000.0, 134217728);
	}
	...
	public function createService0194(): PHPStan\Type\Php\ArrayColumnFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayColumnFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0195(): PHPStan\Type\Php\ArrayCombineFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayCombineFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0196(): PHPStan\Type\Php\ArrayCurrentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayCurrentDynamicReturnTypeExtension;
	}


	public function createService0197(): PHPStan\Type\Php\ArrayFillFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFillFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0198(): PHPStan\Type\Php\ArrayFillKeysFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFillKeysFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0199(): PHPStan\Type\Php\ArrayFilterFunctionReturnTypeHelper
	{
		return new PHPStan\Type\Php\ArrayFilterFunctionReturnTypeHelper($this->getService('reflectionProvider'));
	}


	public function createService0200(): PHPStan\Type\Php\ArrayFilterFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFilterFunctionReturnTypeExtension($this->getService('0199'));
	}


	public function createService0201(): PHPStan\Type\Php\ArrayFlipFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFlipFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0202(): PHPStan\Type\Php\ArrayFindFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFindFunctionReturnTypeExtension($this->getService('0199'));
	}


	public function createService0203(): PHPStan\Type\Php\ArrayFindKeyFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFindKeyFunctionReturnTypeExtension;
	}


	public function createService0204(): PHPStan\Type\Php\ArrayKeyDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeyDynamicReturnTypeExtension;
	}


	public function createService0205(): PHPStan\Type\Php\ArrayKeyExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ArrayKeyExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0206(): PHPStan\Type\Php\ArrayKeyFirstDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeyFirstDynamicReturnTypeExtension;
	}


	public function createService0207(): PHPStan\Type\Php\ArrayKeyLastDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeyLastDynamicReturnTypeExtension;
	}


	public function createService0208(): PHPStan\Type\Php\ArrayKeysFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeysFunctionDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0209(): PHPStan\Type\Php\ArrayMapFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayMapFunctionReturnTypeExtension;
	}


	public function createService0210(): PHPStan\Type\Php\ArrayMergeFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayMergeFunctionDynamicReturnTypeExtension;
	}


	public function createService0211(): PHPStan\Type\Php\ArrayNextDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayNextDynamicReturnTypeExtension;
	}


	public function createService0212(): PHPStan\Type\Php\ArrayPopFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayPopFunctionReturnTypeExtension;
	}


	public function createService0213(): PHPStan\Type\Php\ArrayRandFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayRandFunctionReturnTypeExtension;
	}


	public function createService0214(): PHPStan\Type\Php\ArrayReduceFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayReduceFunctionReturnTypeExtension;
	}


	public function createService0215(): PHPStan\Type\Php\ArrayReplaceFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayReplaceFunctionReturnTypeExtension;
	}


	public function createService0216(): PHPStan\Type\Php\ArrayReverseFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayReverseFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0217(): PHPStan\Type\Php\ArrayShiftFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayShiftFunctionReturnTypeExtension;
	}


	public function createService0218(): PHPStan\Type\Php\ArraySliceFunctionReturnTypeExtension
	{
	...
	public function createService0221(): PHPStan\Type\Php\ArraySearchFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ArraySearchFunctionTypeSpecifyingExtension;
	}


	public function createService0222(): PHPStan\Type\Php\ArrayValuesFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayValuesFunctionDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0223(): PHPStan\Type\Php\ArraySumFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArraySumFunctionDynamicReturnTypeExtension;
	}


	public function createService0224(): PHPStan\Type\Php\AssertThrowTypeExtension
	{
		return new PHPStan\Type\Php\AssertThrowTypeExtension;
	}


	public function createService0225(): PHPStan\Type\Php\BackedEnumFromMethodDynamicReturnTypeExtension
	{
	...
	public function createService0227(): PHPStan\Type\Php\BcMathStringOrNullReturnTypeExtension
	{
		return new PHPStan\Type\Php\BcMathStringOrNullReturnTypeExtension($this->getService('026'));
	}


	public function createService0228(): PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension;
	}


	public function createService0229(): PHPStan\Type\Php\ClosureBindToDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClosureBindToDynamicReturnTypeExtension;
	}


	public function createService0230(): PHPStan\Type\Php\ClosureFromCallableDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClosureFromCallableDynamicReturnTypeExtension;
	}


	public function createService0231(): PHPStan\Type\Php\CompactFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\CompactFunctionReturnTypeExtension(true);
	}


	public function createService0232(): PHPStan\Type\Php\ConstantFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ConstantFunctionReturnTypeExtension($this->getService('0233'));
	}


	public function createService0233(): PHPStan\Type\Php\ConstantHelper
	{
		return new PHPStan\Type\Php\ConstantHelper;
	}


	public function createService0234(): PHPStan\Type\Php\CountFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\CountFunctionReturnTypeExtension;
	}


	public function createService0235(): PHPStan\Type\Php\CountCharsFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\CountCharsFunctionDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0236(): PHPStan\Type\Php\CountFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\CountFunctionTypeSpecifyingExtension;
	}


	public function createService0237(): PHPStan\Type\Php\CurlGetinfoFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\CurlGetinfoFunctionDynamicReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0238(): PHPStan\Type\Php\DateFunctionReturnTypeHelper
	{
		return new PHPStan\Type\Php\DateFunctionReturnTypeHelper;
	}


	public function createService0239(): PHPStan\Type\Php\DateFormatFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateFormatFunctionReturnTypeExtension($this->getService('0238'));
	}


	public function createService0240(): PHPStan\Type\Php\DateFormatMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateFormatMethodReturnTypeExtension($this->getService('0238'));
	}


	public function createService0241(): PHPStan\Type\Php\DateFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateFunctionReturnTypeExtension($this->getService('0238'));
	}


	public function createService0242(): PHPStan\Type\Php\DateIntervalConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateIntervalConstructorThrowTypeExtension($this->getService('026'));
	}


	public function createService0243(): PHPStan\Type\Php\DateIntervalDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateIntervalDynamicReturnTypeExtension;
	}


	public function createService0244(): PHPStan\Type\Php\DateTimeCreateDynamicReturnTypeExtension
	{
	...
	public function createService0248(): PHPStan\Type\Php\DateTimeConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeConstructorThrowTypeExtension($this->getService('026'));
	}


	public function createService0249(): PHPStan\Type\Php\DateTimeModifyMethodThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeModifyMethodThrowTypeExtension($this->getService('026'));
	}


	public function createService0250(): PHPStan\Type\Php\DateTimeSubMethodThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeSubMethodThrowTypeExtension($this->getService('026'));
	}


	public function createService0251(): PHPStan\Type\Php\DateTimeZoneConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeZoneConstructorThrowTypeExtension($this->getService('026'));
	}


	public function createService0252(): PHPStan\Type\Php\DsMapDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\DsMapDynamicReturnTypeExtension;
	}


	public function createService0253(): PHPStan\Type\Php\DsMapDynamicMethodThrowTypeExtension
	{
		return new PHPStan\Type\Php\DsMapDynamicMethodThrowTypeExtension;
	}


	public function createService0254(): PHPStan\Type\Php\DioStatDynamicFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\DioStatDynamicFunctionReturnTypeExtension;
	}


	public function createService0255(): PHPStan\Type\Php\ExplodeFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ExplodeFunctionDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0256(): PHPStan\Type\Php\FilterFunctionReturnTypeHelper
	{
		return new PHPStan\Type\Php\FilterFunctionReturnTypeHelper($this->getService('reflectionProvider'), $this->getService('026'));
	}


	public function createService0257(): PHPStan\Type\Php\FilterInputDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\FilterInputDynamicReturnTypeExtension($this->getService('0256'));
	}


	public function createService0258(): PHPStan\Type\Php\FilterVarDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\FilterVarDynamicReturnTypeExtension($this->getService('0256'));
	}


	public function createService0259(): PHPStan\Type\Php\FilterVarArrayDynamicReturnTypeExtension
	{
	...
	public function createService0260(): PHPStan\Type\Php\GetCalledClassDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\GetCalledClassDynamicReturnTypeExtension;
	}


	public function createService0261(): PHPStan\Type\Php\GetClassDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\GetClassDynamicReturnTypeExtension;
	}


	public function createService0262(): PHPStan\Type\Php\GetDebugTypeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\GetDebugTypeFunctionReturnTypeExtension;
	}


	public function createService0263(): PHPStan\Type\Php\GetDefinedVarsFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\GetDefinedVarsFunctionReturnTypeExtension;
	}


	public function createService0264(): PHPStan\Type\Php\GetParentClassDynamicFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\GetParentClassDynamicFunctionReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0265(): PHPStan\Type\Php\GettypeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\GettypeFunctionReturnTypeExtension;
	}


	public function createService0266(): PHPStan\Type\Php\GettimeofdayDynamicFunctionReturnTypeExtension
	{
	...
	public function createService0268(): PHPStan\Type\Php\HighlightStringDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\HighlightStringDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0269(): PHPStan\Type\Php\IntdivThrowTypeExtension
	{
		return new PHPStan\Type\Php\IntdivThrowTypeExtension;
	}


	public function createService0270(): PHPStan\Type\Php\IniGetReturnTypeExtension
	{
		return new PHPStan\Type\Php\IniGetReturnTypeExtension;
	}


	public function createService0271(): PHPStan\Type\Php\JsonThrowTypeExtension
	{
		return new PHPStan\Type\Php\JsonThrowTypeExtension($this->getService('reflectionProvider'), $this->getService('0188'));
	}


	public function createService0272(): PHPStan\Type\Php\OpenSslEncryptParameterOutTypeExtension
	{
		return new PHPStan\Type\Php\OpenSslEncryptParameterOutTypeExtension;
	}


	public function createService0273(): PHPStan\Type\Php\ParseStrParameterOutTypeExtension
	{
		return new PHPStan\Type\Php\ParseStrParameterOutTypeExtension;
	}


	public function createService0274(): PHPStan\Type\Php\PregMatchTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\PregMatchTypeSpecifyingExtension($this->getService('0277'));
	}


	public function createService0275(): PHPStan\Type\Php\PregMatchParameterOutTypeExtension
	{
		return new PHPStan\Type\Php\PregMatchParameterOutTypeExtension($this->getService('0277'));
	}


	public function createService0276(): PHPStan\Type\Php\PregReplaceCallbackClosureTypeExtension
	{
		return new PHPStan\Type\Php\PregReplaceCallbackClosureTypeExtension($this->getService('0277'));
	}


	public function createService0277(): PHPStan\Type\Php\RegexArrayShapeMatcher
	{
	...
	public function createService0278(): PHPStan\Type\Regex\RegexGroupParser
	{
		return new PHPStan\Type\Regex\RegexGroupParser($this->getService('026'), $this->getService('0279'));
	}


	public function createService0279(): PHPStan\Type\Regex\RegexExpressionHelper
	{
		return new PHPStan\Type\Regex\RegexExpressionHelper($this->getService('096'));
	}


	public function createService0280(): PHPStan\Type\Php\ReflectionClassConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionClassConstructorThrowTypeExtension;
	}


	public function createService0281(): PHPStan\Type\Php\ReflectionFunctionConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionFunctionConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0282(): PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0283(): PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0284(): PHPStan\Type\Php\StrContainingTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\StrContainingTypeSpecifyingExtension;
	}


	public function createService0285(): PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension;
	}


	public function createService0286(): PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension;
	}


	public function createService0287(): PHPStan\Type\Php\StatDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\StatDynamicReturnTypeExtension;
	}


	public function createService0288(): PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension;
	}


	public function createService0289(): PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension($this->getService('0180'));
	}


	public function createService0290(): PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0291(): PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension;
	}


	public function createService0292(): PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension
	{
	...
	public function createService0294(): PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension($this->getService('0188'));
	}


	public function createService0295(): PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension;
	}


	public function createService0296(): PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension;
	}


	public function createService0297(): PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension
	{
	...
	public function createService0299(): PHPStan\Type\Php\MbFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbFunctionsReturnTypeExtension($this->getService('026'));
	}


	public function createService0300(): PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension;
	}


	public function createService0301(): PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0302(): PHPStan\Type\Php\MbStrlenFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbStrlenFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0303(): PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension;
	}


	public function createService0304(): PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension;
	}


	public function createService0305(): PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension;
	}


	public function createService0306(): PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension
	{
	...
	public function createService0308(): PHPStan\Type\Php\StrCaseFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrCaseFunctionsReturnTypeExtension;
	}


	public function createService0309(): PHPStan\Type\Php\StrlenFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrlenFunctionReturnTypeExtension;
	}


	public function createService0310(): PHPStan\Type\Php\StrIncrementDecrementFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrIncrementDecrementFunctionReturnTypeExtension;
	}


	public function createService0311(): PHPStan\Type\Php\StrPadFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrPadFunctionReturnTypeExtension;
	}


	public function createService0312(): PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension;
	}


	public function createService0313(): PHPStan\Type\Php\SubstrDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\SubstrDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0314(): PHPStan\Type\Php\ThrowableReturnTypeExtension
	{
		return new PHPStan\Type\Php\ThrowableReturnTypeExtension;
	}


	public function createService0315(): PHPStan\Type\Php\ParseUrlFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ParseUrlFunctionDynamicReturnTypeExtension;
	}


	public function createService0316(): PHPStan\Type\Php\TriggerErrorDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\TriggerErrorDynamicReturnTypeExtension($this->getService('026'));
	}


	public function createService0317(): PHPStan\Type\Php\TrimFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\TrimFunctionDynamicReturnTypeExtension;
	}


	public function createService0318(): PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension(null, $this->getService('029'));
	}


	public function createService0319(): PHPStan\Type\Php\PowFunctionReturnTypeExtension
	{
	...
	public function createService0321(): PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension;
	}


	public function createService0322(): PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension;
	}


	public function createService0323(): PHPStan\Type\Php\RangeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\RangeFunctionReturnTypeExtension;
	}


	public function createService0324(): PHPStan\Type\Php\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0325(): PHPStan\Type\Php\ClassExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ClassExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0326(): PHPStan\Type\Php\ClassImplementsFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClassImplementsFunctionReturnTypeExtension;
	}


	public function createService0327(): PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension;
	}


	public function createService0328(): PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension($this->getService('0233'));
	}


	public function createService0329(): PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0330(): PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension;
	}


	public function createService0331(): PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension;
	}


	public function createService0332(): PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension($this->getService('0288'));
	}


	public function createService0333(): PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension;
	}


	public function createService0334(): PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension($this->getService('0337'));
	}


	public function createService0335(): PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension;
	}


	public function createService0336(): PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension($this->getService('0337'));
	}


	public function createService0337(): PHPStan\Type\Php\IsAFunctionTypeSpecifyingHelper
	{
		return new PHPStan\Type\Php\IsAFunctionTypeSpecifyingHelper;
	}


	public function createService0338(): PHPStan\Type\Php\CtypeDigitFunctionTypeSpecifyingExtension
	{
	...
	public function createService0340(): PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension
	{
	...
	public function createService0341(): PHPStan\Type\Php\SimpleXMLElementAsXMLMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementAsXMLMethodReturnTypeExtension;
	}


	public function createService0342(): PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension;
	}


	public function createService0343(): PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension($this->getService('026'));
	}


	public function createService0344(): PHPStan\Type\Php\StrTokFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrTokFunctionReturnTypeExtension;
	}


	public function createService0345(): PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension;
	}


	public function createService0346(): PHPStan\Type\Php\SscanfFunctionDynamicReturnTypeExtension
	{
	...
	public function createService0348(): PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension;
	}


	public function createService0349(): PHPStan\Type\Php\XMLReaderOpenReturnTypeExtension
	{
	...
	public function createService0355(): PHPStan\Type\Php\DatePeriodConstructorReturnTypeExtension
	{
		return new PHPStan\Type\Php\DatePeriodConstructorReturnTypeExtension;
	}


	public function createService0356(): PHPStan\Type\PHPStan\ClassNameUsageLocationCreateIdentifierDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPStan\ClassNameUsageLocationCreateIdentifierDynamicReturnTypeExtension;
	}


	public function createService0357(): PHPStan\Type\ClosureTypeFactory
	{
	...
	public function createService0358(): PHPStan\Type\Constant\OversizedArrayBuilder
	{
		return new PHPStan\Type\Constant\OversizedArrayBuilder;
	}


	public function createService0359(): PHPStan\Rules\Functions\PrintfHelper
	{
		return new PHPStan\Rules\Functions\PrintfHelper($this->getService('026'));
	}


	public function createService0360(): PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory
	{
	...
	public function createService0361(): PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory
	{
	...
	public function createService0362(): PHPStan\Reflection\BetterReflection\SourceStubber\PhpStormStubsSourceStubberFactory
	{
	...
	public function createService0363(): PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber
	{
		return $this->getService('0362')->create();
	}


	public function createService0364(): PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber
	{
		return $this->getService('0365')->create();
	}


	public function createService0365(): PHPStan\Reflection\BetterReflection\SourceStubber\ReflectionSourceStubberFactory
	{
	...
	public function createService0366(): PHPStan\Reflection\Deprecation\DeprecationProvider
	{
		return new PHPStan\Reflection\Deprecation\DeprecationProvider($this->getService('075'));
	}


	public function createService0367(): PHPStan\Command\ErrorFormatter\CiDetectedErrorFormatter
	{
	...
	public function createService0368(): PHPStan\Rules\Classes\ExistingClassInClassExtendsRule
	{
	...
	public function createService0369(): PHPStan\Rules\Classes\ExistingClassesInClassImplementsRule
	{
	...
	public function createService0370(): PHPStan\Rules\Classes\ExistingClassesInEnumImplementsRule
	{
	...
	public function createService0371(): PHPStan\Rules\Classes\ExistingClassInInstanceOfRule
	{
	...
	public function createService0372(): PHPStan\Rules\Classes\ExistingClassesInInterfaceExtendsRule
	{
	...
	public function createService0373(): PHPStan\Rules\Classes\ExistingClassInTraitUseRule
	{
	...
	public function createService0374(): PHPStan\Rules\Classes\InstantiationRule
	{
	...
	public function createService0375(): PHPStan\Rules\Exceptions\CaughtExceptionExistenceRule
	{
	...
	public function createService0376(): PHPStan\Rules\Functions\CallToNonExistentFunctionRule
	{
		return new PHPStan\Rules\Functions\CallToNonExistentFunctionRule($this->getService('reflectionProvider'), false, true);
	}


	public function createService0377(): PHPStan\Rules\Constants\OverridingConstantRule
	{
		return new PHPStan\Rules\Constants\OverridingConstantRule(true);
	}


	public function createService0378(): PHPStan\Rules\Methods\OverridingMethodRule
	{
	...
	public function createService0379(): PHPStan\Rules\Missing\MissingReturnRule
	{
		return new PHPStan\Rules\Missing\MissingReturnRule(false, true);
	}


	public function createService0380(): PHPStan\Rules\Namespaces\ExistingNamesInGroupUseRule
	{
	...
	public function createService0381(): PHPStan\Rules\Namespaces\ExistingNamesInUseRule
	{
	...
	public function createService0382(): PHPStan\Rules\Properties\AccessPropertiesRule
	{
		return new PHPStan\Rules\Properties\AccessPropertiesRule($this->getService('0175'));
	}


	public function createService0383(): PHPStan\Rules\Properties\AccessStaticPropertiesRule
	{
	...
	public function createService0384(): PHPStan\Rules\Properties\ExistingClassesInPropertiesRule
	{
	...
	public function createService0385(): PHPStan\Rules\Functions\FunctionCallableRule
	{
	...
	public function createService0386(): PHPStan\Rules\Properties\OverridingPropertyRule
	{
	...
	public function createService0388(): PHPStan\Rules\Properties\WritingToReadOnlyPropertiesRule
	{
	...
	public function createService0389(): PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule
	{
	...
	public function createService0390(): PHPStan\Rules\Variables\CompactVariablesRule
	{
		return new PHPStan\Rules\Variables\CompactVariablesRule(true);
	}


	public function createService0391(): PHPStan\Rules\Variables\DefinedVariableRule
	{
		return new PHPStan\Rules\Variables\DefinedVariableRule(true, true);
	}


	public function createService0392(): PHPStan\Rules\Keywords\RequireFileExistsRule
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/Users/mantum/Documents/test-paypal');
	}


	public function createService0393(): PHPStan\Rules\InternalTag\RestrictedInternalClassConstantUsageExtension
	{
		return new PHPStan\Rules\InternalTag\RestrictedInternalClassConstantUsageExtension($this->getService('0157'));
	}


	public function createService0394(): PHPStan\Rules\InternalTag\RestrictedInternalClassNameUsageExtension
	{
		return new PHPStan\Rules\InternalTag\RestrictedInternalClassNameUsageExtension($this->getService('0157'));
	}


	public function createService0395(): PHPStan\Rules\InternalTag\RestrictedInternalFunctionUsageExtension
	{
		return new PHPStan\Rules\InternalTag\RestrictedInternalFunctionUsageExtension($this->getService('0157'));
	}


	public function createService0396(): PHPStan\Rules\Constants\ConstantRule
	{
		return new PHPStan\Rules\Constants\ConstantRule(true);
	}


	public function createService0397(): PHPStan\Rules\Classes\MixinRule
	{
		return new PHPStan\Rules\Classes\MixinRule($this->getService('0137'));
	}


	public function createService0398(): PHPStan\Rules\PhpDoc\RequireExtendsCheck
	{
		return new PHPStan\Rules\PhpDoc\RequireExtendsCheck($this->getService('0132'), true, true);
	}


	public function createService0399(): PHPStan\Rules\PhpDoc\RequireImplementsDefinitionTraitRule
	{
	...
	public function createService0400(): PHPStan\Rules\Functions\CallCallablesRule
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0147'), $this->getService('0182'), true);
	}


	public function createService0401(): PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule($this->getService('031'), $this->getService('034'));
	}


	public function createService0402(): PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule
	{
	...
	public function createService0403(): PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule($this->getService('031'), $this->getService('034'));
	}


	public function createService0404(): PHPStan\Rules\InternalTag\RestrictedInternalPropertyUsageExtension
	{
		return new PHPStan\Rules\InternalTag\RestrictedInternalPropertyUsageExtension($this->getService('0157'));
	}


	public function createService0405(): PHPStan\Rules\InternalTag\RestrictedInternalMethodUsageExtension
	{
		return new PHPStan\Rules\InternalTag\RestrictedInternalMethodUsageExtension($this->getService('0157'));
	}


	public function createService0406(): PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0182'), true);
	}


	public function createService0407(): PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule(true);
	}


	public function createService0408(): PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0182'), $this->getService('0131'), true);
	}


	public function createService0409(): PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule
	{
	...
	public function createService0410(): PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule
	{
	...
	public function createService0411(): PHPStan\Rules\Exceptions\ThrowsVoidPropertyHookWithExplicitThrowPointRule
	{
	...
	public function createService0414(): PHPStan\Rules\Classes\ImpossibleInstanceOfRule
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(true, false, true);
	}


	public function createService0415(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('0139'), true, false, true);
	}


	public function createService0416(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
	...
	public function createService0418(): PHPStan\Rules\DeadCode\ConstructorWithoutImpurePointsCollector
	{
		return new PHPStan\Rules\DeadCode\ConstructorWithoutImpurePointsCollector;
	}


	public function createService0419(): PHPStan\Rules\DeadCode\PossiblyPureNewCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureNewCollector($this->getService('reflectionProvider'));
	}


	public function createService0420(): PHPStan\Rules\DeadCode\FunctionWithoutImpurePointsCollector
	{
		return new PHPStan\Rules\DeadCode\FunctionWithoutImpurePointsCollector;
	}


	public function createService0421(): PHPStan\Rules\DeadCode\PossiblyPureFuncCallCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureFuncCallCollector($this->getService('reflectionProvider'));
	}


	public function createService0422(): PHPStan\Rules\DeadCode\MethodWithoutImpurePointsCollector
	{
		return new PHPStan\Rules\DeadCode\MethodWithoutImpurePointsCollector;
	}


	public function createService0423(): PHPStan\Rules\DeadCode\PossiblyPureMethodCallCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureMethodCallCollector;
	}


	public function createService0424(): PHPStan\Rules\DeadCode\PossiblyPureStaticCallCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureStaticCallCollector;
	}


	public function createService0425(): PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule
	{
	...
	public function createService0428(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('0139'), true, true);
	}


	public function createService0429(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0140'), true, false, true);
	}


	public function createService0430(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0140'), true, false, true);
	}


	public function createService0431(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0140'), true, false, true);
	}


	public function createService0432(): PHPStan\Rules\Comparison\LogicalXorConstantConditionRule
	{
	...
	public function createService0438(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('0139'), true, true);
	}


	public function createService0439(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('0139'), true, true);
	}


	public function createService0440(): PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule($this->getService('0146'));
	}


	public function createService0441(): PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule($this->getService('0185'), $this->getService('0146'));
	}


	public function createService0442(): PHPStan\Rules\Exceptions\TooWidePropertyHookThrowTypeRule
	{
	...
	public function createService0447(): PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule
	{
		return new PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule($this->getService('exceptionTypeResolver'), true);
	}


	public function createService0448(): PHPStan\Rules\Functions\RandomIntParametersRule
	{
	...
	public function createService0449(): PHPStan\Rules\Functions\ArrayFilterRule
	{
		return new PHPStan\Rules\Functions\ArrayFilterRule($this->getService('reflectionProvider'), true, true);
	}


	public function createService0450(): PHPStan\Rules\Functions\ArrayValuesRule
	{
		return new PHPStan\Rules\Functions\ArrayValuesRule($this->getService('reflectionProvider'), true, true);
	}


	public function createService0451(): PHPStan\Rules\Functions\ParameterCastableToNumberRule
	{
	...
	public function createService0452(): Larastan\Larastan\Methods\RelationForwardsCallsExtension
	{
		return new Larastan\Larastan\Methods\RelationForwardsCallsExtension(
			$this->getService('0526'),
			$this->getService('reflectionProvider')
		);
	}


	public function createService0453(): Larastan\Larastan\Methods\ModelForwardsCallsExtension
	{
	...
	public function createService0454(): Larastan\Larastan\Methods\EloquentBuilderForwardsCallsExtension
	{
	...
	public function createService0455(): Larastan\Larastan\Methods\HigherOrderTapProxyExtension
	{
		return new Larastan\Larastan\Methods\HigherOrderTapProxyExtension;
	}


	public function createService0456(): Larastan\Larastan\Methods\HigherOrderCollectionProxyExtension
	{
		return new Larastan\Larastan\Methods\HigherOrderCollectionProxyExtension($this->getService('0553'));
	}


	public function createService0457(): Larastan\Larastan\Methods\StorageMethodsClassReflectionExtension
	{
		return new Larastan\Larastan\Methods\StorageMethodsClassReflectionExtension($this->getService('reflectionProvider'));
	}


	public function createService0458(): Larastan\Larastan\Methods\Extension
	{
		return new Larastan\Larastan\Methods\Extension($this->getService('0116'), $this->getService('reflectionProvider'));
	}


	public function createService0459(): Larastan\Larastan\Methods\ModelFactoryMethodsClassReflectionExtension
	{
		return new Larastan\Larastan\Methods\ModelFactoryMethodsClassReflectionExtension($this->getService('reflectionProvider'));
	}


	public function createService0460(): Larastan\Larastan\Methods\RedirectResponseMethodsClassReflectionExtension
	{
		return new Larastan\Larastan\Methods\RedirectResponseMethodsClassReflectionExtension;
	}


	public function createService0461(): Larastan\Larastan\Methods\MacroMethodsClassReflectionExtension
	{
	...
	public function createService0462(): Larastan\Larastan\Methods\ViewWithMethodsClassReflectionExtension
	{
		return new Larastan\Larastan\Methods\ViewWithMethodsClassReflectionExtension;
	}


	public function createService0463(): Larastan\Larastan\Properties\ModelAccessorExtension
	{
		return new Larastan\Larastan\Properties\ModelAccessorExtension($this->getService('0524'));
	}


	public function createService0464(): Larastan\Larastan\Properties\ModelPropertyExtension
	{
		return new Larastan\Larastan\Properties\ModelPropertyExtension($this->getService('0524'));
	}


	public function createService0465(): Larastan\Larastan\Properties\HigherOrderCollectionProxyPropertyExtension
	{
		return new Larastan\Larastan\Properties\HigherOrderCollectionProxyPropertyExtension($this->getService('0553'));
	}


	public function createService0466(): Larastan\Larastan\ReturnTypes\HigherOrderTapProxyExtension
	{
		return new Larastan\Larastan\ReturnTypes\HigherOrderTapProxyExtension;
	}


	public function createService0467(): Larastan\Larastan\ReturnTypes\ContainerArrayAccessDynamicMethodReturnTypeExtension
	{
	...
	public function createService0468(): Larastan\Larastan\ReturnTypes\ContainerArrayAccessDynamicMethodReturnTypeExtension
	{
	...
	public function createService0469(): Larastan\Larastan\ReturnTypes\ContainerArrayAccessDynamicMethodReturnTypeExtension
	{
	...
	public function createService0470(): Larastan\Larastan\ReturnTypes\ContainerArrayAccessDynamicMethodReturnTypeExtension
	{
	...
	public function createService0471(): Larastan\Larastan\Properties\ModelRelationsExtension
	{
		return new Larastan\Larastan\Properties\ModelRelationsExtension($this->getService('0489'));
	}


	public function createService0472(): Larastan\Larastan\ReturnTypes\ModelOnlyDynamicMethodReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\ModelOnlyDynamicMethodReturnTypeExtension;
	}


	public function createService0473(): Larastan\Larastan\ReturnTypes\ModelFactoryDynamicStaticMethodReturnTypeExtension
	{
	...
	public function createService0474(): Larastan\Larastan\ReturnTypes\ModelDynamicStaticMethodReturnTypeExtension
	{
	...
	public function createService0475(): Larastan\Larastan\ReturnTypes\AppMakeDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\AppMakeDynamicReturnTypeExtension($this->getService('0550'));
	}


	public function createService0476(): Larastan\Larastan\ReturnTypes\AuthExtension
	{
		return new Larastan\Larastan\ReturnTypes\AuthExtension;
	}


	public function createService0477(): Larastan\Larastan\ReturnTypes\GuardDynamicStaticMethodReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\GuardDynamicStaticMethodReturnTypeExtension;
	}


	public function createService0478(): Larastan\Larastan\ReturnTypes\AuthManagerExtension
	{
		return new Larastan\Larastan\ReturnTypes\AuthManagerExtension;
	}


	public function createService0479(): Larastan\Larastan\ReturnTypes\DateExtension
	{
		return new Larastan\Larastan\ReturnTypes\DateExtension;
	}


	public function createService0480(): Larastan\Larastan\ReturnTypes\GuardExtension
	{
		return new Larastan\Larastan\ReturnTypes\GuardExtension;
	}


	public function createService0481(): Larastan\Larastan\ReturnTypes\RequestFileExtension
	{
		return new Larastan\Larastan\ReturnTypes\RequestFileExtension;
	}


	public function createService0482(): Larastan\Larastan\ReturnTypes\RequestRouteExtension
	{
		return new Larastan\Larastan\ReturnTypes\RequestRouteExtension;
	}


	public function createService0483(): Larastan\Larastan\ReturnTypes\RequestUserExtension
	{
		return new Larastan\Larastan\ReturnTypes\RequestUserExtension;
	}


	public function createService0484(): Larastan\Larastan\ReturnTypes\EloquentBuilderExtension
	{
	...
	public function createService0485(): Larastan\Larastan\ReturnTypes\RelationCollectionExtension
	{
	...
	public function createService0486(): Larastan\Larastan\ReturnTypes\ModelFindExtension
	{
		return new Larastan\Larastan\ReturnTypes\ModelFindExtension($this->getService('reflectionProvider'), $this->getService('0489'));
	}


	public function createService0487(): Larastan\Larastan\ReturnTypes\BuilderModelFindExtension
	{
	...
	public function createService0488(): Larastan\Larastan\ReturnTypes\TestCaseExtension
	{
		return new Larastan\Larastan\ReturnTypes\TestCaseExtension;
	}


	public function createService0489(): Larastan\Larastan\Support\CollectionHelper
	{
		return new Larastan\Larastan\Support\CollectionHelper($this->getService('reflectionProvider'));
	}


	public function createService0490(): Larastan\Larastan\ReturnTypes\Helpers\AuthExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\AuthExtension;
	}


	public function createService0491(): Larastan\Larastan\ReturnTypes\Helpers\CollectExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\CollectExtension($this->getService('0489'));
	}


	public function createService0492(): Larastan\Larastan\ReturnTypes\Helpers\NowAndTodayExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\NowAndTodayExtension;
	}


	public function createService0493(): Larastan\Larastan\ReturnTypes\Helpers\ResponseExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\ResponseExtension;
	}


	public function createService0494(): Larastan\Larastan\ReturnTypes\Helpers\ValidatorExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\ValidatorExtension;
	}


	public function createService0495(): Larastan\Larastan\ReturnTypes\Helpers\LiteralExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\LiteralExtension;
	}


	public function createService0496(): Larastan\Larastan\ReturnTypes\CollectionFilterRejectDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\CollectionFilterRejectDynamicReturnTypeExtension;
	}


	public function createService0497(): Larastan\Larastan\ReturnTypes\CollectionWhereNotNullDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\CollectionWhereNotNullDynamicReturnTypeExtension;
	}


	public function createService0498(): Larastan\Larastan\ReturnTypes\NewModelQueryDynamicMethodReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\NewModelQueryDynamicMethodReturnTypeExtension($this->getService('0526'));
	}


	public function createService0499(): Larastan\Larastan\ReturnTypes\FactoryDynamicMethodReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\FactoryDynamicMethodReturnTypeExtension;
	}


	public function createService0500(): Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension
	{
		return new Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension(false, 'abort');
	}


	public function createService0501(): Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension
	{
		return new Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension(true, 'abort');
	}


	public function createService0502(): Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension
	{
		return new Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension(false, 'throw');
	}


	public function createService0503(): Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension
	{
		return new Larastan\Larastan\Types\AbortIfFunctionTypeSpecifyingExtension(true, 'throw');
	}


	public function createService0504(): Larastan\Larastan\ReturnTypes\Helpers\AppExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\AppExtension($this->getService('0550'));
	}


	public function createService0505(): Larastan\Larastan\ReturnTypes\Helpers\ValueExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\ValueExtension;
	}


	public function createService0506(): Larastan\Larastan\ReturnTypes\Helpers\StrExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\StrExtension;
	}


	public function createService0507(): Larastan\Larastan\ReturnTypes\Helpers\TapExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\TapExtension;
	}


	public function createService0508(): Larastan\Larastan\ReturnTypes\StorageDynamicStaticMethodReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\StorageDynamicStaticMethodReturnTypeExtension;
	}


	public function createService0509(): Larastan\Larastan\Types\GenericEloquentCollectionTypeNodeResolverExtension
	{
		return new Larastan\Larastan\Types\GenericEloquentCollectionTypeNodeResolverExtension($this->getService('040'));
	}


	public function createService0510(): Larastan\Larastan\Types\ViewStringTypeNodeResolverExtension
	{
		return new Larastan\Larastan\Types\ViewStringTypeNodeResolverExtension;
	}


	public function createService0511(): Larastan\Larastan\Rules\OctaneCompatibilityRule
	{
		return new Larastan\Larastan\Rules\OctaneCompatibilityRule;
	}


	public function createService0512(): Larastan\Larastan\Rules\NoEnvCallsOutsideOfConfigRule
	{
		return new Larastan\Larastan\Rules\NoEnvCallsOutsideOfConfigRule([], $this->getService('085'));
	}


	public function createService0513(): Larastan\Larastan\Rules\NoModelMakeRule
	{
		return new Larastan\Larastan\Rules\NoModelMakeRule($this->getService('reflectionProvider'));
	}


	public function createService0514(): Larastan\Larastan\Rules\NoUnnecessaryCollectionCallRule
	{
	...
	public function createService0515(): Larastan\Larastan\Rules\ModelAppendsRule
	{
		return new Larastan\Larastan\Rules\ModelAppendsRule($this->getService('0524'));
	}


	public function createService0516(): Larastan\Larastan\Types\GenericEloquentBuilderTypeNodeResolverExtension
	{
		return new Larastan\Larastan\Types\GenericEloquentBuilderTypeNodeResolverExtension($this->getService('reflectionProvider'));
	}


	public function createService0517(): Larastan\Larastan\ReturnTypes\AppEnvironmentReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\AppEnvironmentReturnTypeExtension('Illuminate\Foundation\Application');
	}


	public function createService0518(): Larastan\Larastan\ReturnTypes\AppEnvironmentReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\AppEnvironmentReturnTypeExtension('Illuminate\Contracts\Foundation\Application');
	}


	public function createService0519(): Larastan\Larastan\ReturnTypes\AppFacadeEnvironmentReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\AppFacadeEnvironmentReturnTypeExtension;
	}


	public function createService0520(): Larastan\Larastan\Types\ModelProperty\ModelPropertyTypeNodeResolverExtension
	{
	...
	public function createService0521(): Larastan\Larastan\Properties\MigrationHelper
	{
	...
	public function createService0522(): Larastan\Larastan\Properties\SquashedMigrationHelper
	{
		return new Larastan\Larastan\Properties\SquashedMigrationHelper([], $this->getService('085'), $this->getService('0530'), false);
	}


	public function createService0523(): Larastan\Larastan\Properties\ModelCastHelper
	{
		return new Larastan\Larastan\Properties\ModelCastHelper($this->getService('reflectionProvider'));
	}


	public function createService0524(): Larastan\Larastan\Properties\ModelPropertyHelper
	{
	...
	public function createService0525(): Larastan\Larastan\Rules\ModelRuleHelper
	{
		return new Larastan\Larastan\Rules\ModelRuleHelper;
	}


	public function createService0526(): Larastan\Larastan\Methods\BuilderHelper
	{
		return new Larastan\Larastan\Methods\BuilderHelper($this->getService('reflectionProvider'), false, $this->getService('0461'));
	}


	public function createService0527(): Larastan\Larastan\Rules\RelationExistenceRule
	{
		return new Larastan\Larastan\Rules\RelationExistenceRule($this->getService('0525'));
	}


	public function createService0528(): Larastan\Larastan\Rules\CheckDispatchArgumentTypesCompatibleWithClassConstructorRule
	{
	...
	public function createService0529(): Larastan\Larastan\Rules\CheckDispatchArgumentTypesCompatibleWithClassConstructorRule
	{
		return new Larastan\Larastan\Rules\CheckDispatchArgumentTypesCompatibleWithClassConstructorRule(
			$this->getService('reflectionProvider'),
			$this->getService('0147'),
	...
	public function createService0530(): Larastan\Larastan\Properties\Schema\MySqlDataTypeToPhpTypeConverter
	{
		return new Larastan\Larastan\Properties\Schema\MySqlDataTypeToPhpTypeConverter;
	}


	public function createService0531(): Larastan\Larastan\LarastanStubFilesExtension
	{
		return new Larastan\Larastan\LarastanStubFilesExtension;
	}


	public function createService0532(): Larastan\Larastan\Rules\UnusedViewsRule
	{
		return new Larastan\Larastan\Rules\UnusedViewsRule($this->getService('0538'), $this->getService('0539'));
	}


	public function createService0533(): Larastan\Larastan\Collectors\UsedViewFunctionCollector
	{
		return new Larastan\Larastan\Collectors\UsedViewFunctionCollector;
	}


	public function createService0534(): Larastan\Larastan\Collectors\UsedEmailViewCollector
	{
		return new Larastan\Larastan\Collectors\UsedEmailViewCollector;
	}


	public function createService0535(): Larastan\Larastan\Collectors\UsedViewMakeCollector
	{
		return new Larastan\Larastan\Collectors\UsedViewMakeCollector;
	}


	public function createService0536(): Larastan\Larastan\Collectors\UsedViewFacadeMakeCollector
	{
		return new Larastan\Larastan\Collectors\UsedViewFacadeMakeCollector;
	}


	public function createService0537(): Larastan\Larastan\Collectors\UsedRouteFacadeViewCollector
	{
		return new Larastan\Larastan\Collectors\UsedRouteFacadeViewCollector;
	}


	public function createService0538(): Larastan\Larastan\Collectors\UsedViewInAnotherViewCollector
	{
	...
	public function createService0539(): Larastan\Larastan\Support\ViewFileHelper
	{
		return new Larastan\Larastan\Support\ViewFileHelper([], $this->getService('085'));
	}


	public function createService0540(): Larastan\Larastan\ReturnTypes\ApplicationMakeDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\ApplicationMakeDynamicReturnTypeExtension($this->getService('0550'));
	}


	public function createService0541(): Larastan\Larastan\ReturnTypes\ContainerMakeDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\ContainerMakeDynamicReturnTypeExtension($this->getService('0550'));
	}


	public function createService0542(): Larastan\Larastan\ReturnTypes\ConsoleCommand\ArgumentDynamicReturnTypeExtension
	{
	...
	public function createService0543(): Larastan\Larastan\ReturnTypes\ConsoleCommand\HasArgumentDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\ConsoleCommand\HasArgumentDynamicReturnTypeExtension($this->getService('0551'));
	}


	public function createService0544(): Larastan\Larastan\ReturnTypes\ConsoleCommand\OptionDynamicReturnTypeExtension
	{
	...
	public function createService0545(): Larastan\Larastan\ReturnTypes\ConsoleCommand\HasOptionDynamicReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\ConsoleCommand\HasOptionDynamicReturnTypeExtension($this->getService('0551'));
	}


	public function createService0546(): Larastan\Larastan\ReturnTypes\TranslatorGetReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\TranslatorGetReturnTypeExtension;
	}


	public function createService0547(): Larastan\Larastan\ReturnTypes\LangGetReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\LangGetReturnTypeExtension;
	}


	public function createService0548(): Larastan\Larastan\ReturnTypes\TransHelperReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\TransHelperReturnTypeExtension;
	}


	public function createService0549(): Larastan\Larastan\ReturnTypes\DoubleUnderscoreHelperReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\DoubleUnderscoreHelperReturnTypeExtension;
	}


	public function createService0550(): Larastan\Larastan\ReturnTypes\AppMakeHelper
	{
		return new Larastan\Larastan\ReturnTypes\AppMakeHelper;
	}


	public function createService0551(): Larastan\Larastan\Internal\ConsoleApplicationResolver
	{
		return new Larastan\Larastan\Internal\ConsoleApplicationResolver;
	}


	public function createService0552(): Larastan\Larastan\Internal\ConsoleApplicationHelper
	{
		return new Larastan\Larastan\Internal\ConsoleApplicationHelper($this->getService('0551'));
	}


	public function createService0553(): Larastan\Larastan\Support\HigherOrderCollectionProxyHelper
	{
		return new Larastan\Larastan\Support\HigherOrderCollectionProxyHelper($this->getService('reflectionProvider'));
	}


	public function createService0554(): Larastan\Larastan\ReturnTypes\Helpers\ConfigFunctionDynamicFunctionReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\ConfigFunctionDynamicFunctionReturnTypeExtension($this->getService('0556'));
	}


	public function createService0555(): Larastan\Larastan\ReturnTypes\ConfigGetDynamicMethodReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\ConfigGetDynamicMethodReturnTypeExtension($this->getService('0556'));
	}


	public function createService0556(): Larastan\Larastan\Support\ConfigParser
	{
	...
	public function createService0557(): Larastan\Larastan\ReturnTypes\Helpers\EnvFunctionDynamicFunctionReturnTypeExtension
	{
		return new Larastan\Larastan\ReturnTypes\Helpers\EnvFunctionDynamicFunctionReturnTypeExtension;
	}


	public function createService0558(): Larastan\Larastan\ReturnTypes\FormRequestSafeDynamicMethodReturnTypeExtension
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/Users/mantum/Documents/test-paypal/.phpstan-cache/cache/PHPStan');
	}


	public function createServiceContainer(): Container_5126a765a5
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/Users/mantum/Documents/test-paypal');
	}
	...
	public function createServiceRules__100(): PHPStan\Rules\Properties\PropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\PropertyAssignRefRule($this->getService('026'), $this->getService('0180'));
	}


	public function createServiceRules__101(): PHPStan\Rules\Properties\PropertyAttributesRule
	{
		return new PHPStan\Rules\Properties\PropertyAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__102(): PHPStan\Rules\Properties\PropertyHookAttributesRule
	{
		return new PHPStan\Rules\Properties\PropertyHookAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__103(): PHPStan\Rules\Properties\PropertyInClassRule
	{
		return new PHPStan\Rules\Properties\PropertyInClassRule($this->getService('026'));
	}


	public function createServiceRules__104(): PHPStan\Rules\Properties\ReadOnlyPropertyRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyRule($this->getService('026'));
	}


	public function createServiceRules__105(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyRule;
	}


	public function createServiceRules__106(): PHPStan\Rules\Regexp\RegularExpressionPatternRule
	{
		return new PHPStan\Rules\Regexp\RegularExpressionPatternRule($this->getService('0279'));
	}


	public function createServiceRules__107(): PHPStan\Rules\Traits\ConflictingTraitConstantsRule
	{
		return new PHPStan\Rules\Traits\ConflictingTraitConstantsRule($this->getService('096'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__108(): PHPStan\Rules\Traits\ConstantsInTraitsRule
	{
		return new PHPStan\Rules\Traits\ConstantsInTraitsRule($this->getService('026'));
	}


	public function createServiceRules__109(): PHPStan\Rules\Traits\TraitAttributesRule
	{
	...
	public function createServiceRules__110(): PHPStan\Rules\Types\InvalidTypesInUnionRule
	{
		return new PHPStan\Rules\Types\InvalidTypesInUnionRule;
	}


	public function createServiceRules__111(): PHPStan\Rules\Variables\UnsetRule
	{
		return new PHPStan\Rules\Variables\UnsetRule($this->getService('0180'), $this->getService('026'));
	}


	public function createServiceRules__112(): PHPStan\Rules\Whitespace\FileWhitespaceRule
	{
		return new PHPStan\Rules\Whitespace\FileWhitespaceRule;
	}


	public function createServiceRules__113(): PHPStan\Rules\Classes\UnusedConstructorParametersRule
	{
		return new PHPStan\Rules\Classes\UnusedConstructorParametersRule($this->getService('0183'));
	}


	public function createServiceRules__114(): PHPStan\Rules\Functions\UnusedClosureUsesRule
	{
		return new PHPStan\Rules\Functions\UnusedClosureUsesRule($this->getService('0183'));
	}


	public function createServiceRules__115(): PHPStan\Rules\Variables\EmptyRule
	{
		return new PHPStan\Rules\Variables\EmptyRule($this->getService('0158'));
	}


	public function createServiceRules__116(): PHPStan\Rules\Variables\IssetRule
	{
		return new PHPStan\Rules\Variables\IssetRule($this->getService('0158'));
	}


	public function createServiceRules__117(): PHPStan\Rules\Variables\NullCoalesceRule
	{
		return new PHPStan\Rules\Variables\NullCoalesceRule($this->getService('0158'));
	}


	public function createServiceRules__118(): PHPStan\Rules\Cast\EchoRule
	{
		return new PHPStan\Rules\Cast\EchoRule($this->getService('0182'));
	}


	public function createServiceRules__119(): PHPStan\Rules\Cast\InvalidCastRule
	{
	...
	public function createServiceRules__120(): PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule
	{
		return new PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule($this->getService('023'), $this->getService('0182'));
	}


	public function createServiceRules__121(): PHPStan\Rules\Cast\PrintRule
	{
		return new PHPStan\Rules\Cast\PrintRule($this->getService('0182'));
	}


	public function createServiceRules__122(): PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule
	{
		return new PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule;
	}


	public function createServiceRules__123(): PHPStan\Rules\Classes\MethodTagRule
	{
		return new PHPStan\Rules\Classes\MethodTagRule($this->getService('0136'));
	}


	public function createServiceRules__124(): PHPStan\Rules\Classes\MethodTagTraitRule
	{
		return new PHPStan\Rules\Classes\MethodTagTraitRule($this->getService('0136'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__125(): PHPStan\Rules\Classes\MethodTagTraitUseRule
	{
		return new PHPStan\Rules\Classes\MethodTagTraitUseRule($this->getService('0136'));
	}


	public function createServiceRules__126(): PHPStan\Rules\Classes\PropertyTagRule
	{
		return new PHPStan\Rules\Classes\PropertyTagRule($this->getService('0138'));
	}


	public function createServiceRules__127(): PHPStan\Rules\Classes\PropertyTagTraitRule
	{
		return new PHPStan\Rules\Classes\PropertyTagTraitRule($this->getService('0138'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__128(): PHPStan\Rules\Classes\PropertyTagTraitUseRule
	{
		return new PHPStan\Rules\Classes\PropertyTagTraitUseRule($this->getService('0138'));
	}


	public function createServiceRules__129(): PHPStan\Rules\Classes\MixinTraitRule
	{
		return new PHPStan\Rules\Classes\MixinTraitRule($this->getService('0137'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__13(): PHPStan\Rules\Api\ApiInstanceofRule
	{
		return new PHPStan\Rules\Api\ApiInstanceofRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__130(): PHPStan\Rules\Classes\MixinTraitUseRule
	{
		return new PHPStan\Rules\Classes\MixinTraitUseRule($this->getService('0137'));
	}


	public function createServiceRules__131(): PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule;
	}


	public function createServiceRules__132(): PHPStan\Rules\Constants\ValueAssignedToClassConstantRule
	{
		return new PHPStan\Rules\Constants\ValueAssignedToClassConstantRule;
	}


	public function createServiceRules__133(): PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__134(): PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule;
	}


	public function createServiceRules__135(): PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule;
	}


	public function createServiceRules__136(): PHPStan\Rules\Generics\ClassAncestorsRule
	{
		return new PHPStan\Rules\Generics\ClassAncestorsRule($this->getService('0152'), $this->getService('0151'));
	}


	public function createServiceRules__137(): PHPStan\Rules\Generics\ClassTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\ClassTemplateTypeRule($this->getService('0155'));
	}


	public function createServiceRules__138(): PHPStan\Rules\Generics\EnumAncestorsRule
	{
		return new PHPStan\Rules\Generics\EnumAncestorsRule($this->getService('0152'), $this->getService('0151'));
	}


	public function createServiceRules__139(): PHPStan\Rules\Generics\EnumTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\EnumTemplateTypeRule;
	}


	public function createServiceRules__14(): PHPStan\Rules\Api\ApiInstanceofTypeRule
	{
		return new PHPStan\Rules\Api\ApiInstanceofTypeRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__140(): PHPStan\Rules\Generics\FunctionTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\FunctionTemplateTypeRule($this->getService('0185'), $this->getService('0155'));
	}


	public function createServiceRules__141(): PHPStan\Rules\Generics\FunctionSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\FunctionSignatureVarianceRule($this->getService('0156'));
	}


	public function createServiceRules__142(): PHPStan\Rules\Generics\InterfaceAncestorsRule
	{
		return new PHPStan\Rules\Generics\InterfaceAncestorsRule($this->getService('0152'), $this->getService('0151'));
	}


	public function createServiceRules__143(): PHPStan\Rules\Generics\InterfaceTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\InterfaceTemplateTypeRule($this->getService('0155'));
	}


	public function createServiceRules__144(): PHPStan\Rules\Generics\MethodTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTemplateTypeRule($this->getService('0185'), $this->getService('0155'));
	}


	public function createServiceRules__145(): PHPStan\Rules\Generics\MethodTagTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTagTemplateTypeRule($this->getService('0154'));
	}


	public function createServiceRules__146(): PHPStan\Rules\Generics\MethodTagTemplateTypeTraitRule
	{
	...
	public function createServiceRules__147(): PHPStan\Rules\Generics\MethodSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\MethodSignatureVarianceRule($this->getService('0156'));
	}


	public function createServiceRules__148(): PHPStan\Rules\Generics\PropertyVarianceRule
	{
		return new PHPStan\Rules\Generics\PropertyVarianceRule($this->getService('0156'));
	}


	public function createServiceRules__149(): PHPStan\Rules\Generics\TraitTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\TraitTemplateTypeRule($this->getService('0185'), $this->getService('0155'));
	}


	public function createServiceRules__15(): PHPStan\Rules\Api\ApiInstantiationRule
	{
		return new PHPStan\Rules\Api\ApiInstantiationRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__150(): PHPStan\Rules\Generics\UsedTraitsRule
	{
		return new PHPStan\Rules\Generics\UsedTraitsRule($this->getService('0185'), $this->getService('0152'));
	}


	public function createServiceRules__151(): PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule
	{
		return new PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule;
	}


	public function createServiceRules__152(): PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__153(): PHPStan\Rules\Operators\InvalidBinaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidBinaryOperationRule($this->getService('023'), $this->getService('0182'));
	}


	public function createServiceRules__154(): PHPStan\Rules\Operators\InvalidComparisonOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('0182'));
	}


	public function createServiceRules__155(): PHPStan\Rules\Operators\InvalidUnaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidUnaryOperationRule($this->getService('0182'));
	}


	public function createServiceRules__156(): PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule($this->getService('0168'));
	}


	public function createServiceRules__157(): PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule($this->getService('0168'));
	}


	public function createServiceRules__158(): PHPStan\Rules\PhpDoc\FunctionAssertRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionAssertRule($this->getService('0169'));
	}


	public function createServiceRules__159(): PHPStan\Rules\PhpDoc\MethodAssertRule
	{
		return new PHPStan\Rules\PhpDoc\MethodAssertRule($this->getService('0169'));
	}


	public function createServiceRules__16(): PHPStan\Rules\Api\ApiClassConstFetchRule
	{
		return new PHPStan\Rules\Api\ApiClassConstFetchRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__160(): PHPStan\Rules\PhpDoc\IncompatibleSelfOutTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleSelfOutTypeRule($this->getService('0170'), $this->getService('0153'));
	}


	public function createServiceRules__161(): PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule($this->getService('0153'), $this->getService('0170'));
	}


	public function createServiceRules__162(): PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule($this->getService('0185'), $this->getService('0172'));
	}


	public function createServiceRules__163(): PHPStan\Rules\PhpDoc\IncompatiblePropertyHookPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePropertyHookPhpDocTypeRule($this->getService('0185'), $this->getService('0172'));
	}


	public function createServiceRules__164(): PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule
	{
	...
	public function createServiceRules__165(): PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule($this->getService('0185'));
	}


	public function createServiceRules__166(): PHPStan\Rules\PhpDoc\IncompatibleParamImmediatelyInvokedCallableRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleParamImmediatelyInvokedCallableRule($this->getService('0185'));
	}


	public function createServiceRules__167(): PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule
	{
		return new PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule($this->getService('0173'));
	}


	public function createServiceRules__168(): PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule
	{
		return new PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule($this->getService('0185'), $this->getService('0173'));
	}


	public function createServiceRules__169(): PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule
	{
		return new PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule;
	}


	public function createServiceRules__17(): PHPStan\Rules\Api\ApiClassExtendsRule
	{
		return new PHPStan\Rules\Api\ApiClassExtendsRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__170(): PHPStan\Rules\Classes\RequireImplementsRule
	{
		return new PHPStan\Rules\Classes\RequireImplementsRule;
	}


	public function createServiceRules__171(): PHPStan\Rules\Classes\RequireExtendsRule
	{
		return new PHPStan\Rules\Classes\RequireExtendsRule;
	}


	public function createServiceRules__172(): PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule
	{
		return new PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule;
	}


	public function createServiceRules__173(): PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule
	{
		return new PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule($this->getService('0398'));
	}


	public function createServiceRules__174(): PHPStan\Rules\PhpDoc\RequireExtendsDefinitionTraitRule
	{
	...
	public function createServiceRules__175(): PHPStan\Rules\Pure\PureFunctionRule
	{
		return new PHPStan\Rules\Pure\PureFunctionRule($this->getService('0181'));
	}


	public function createServiceRules__176(): PHPStan\Rules\Pure\PureMethodRule
	{
		return new PHPStan\Rules\Pure\PureMethodRule($this->getService('0181'));
	}


	public function createServiceRules__177(): PHPStan\Rules\Arrays\ArrayDestructuringRule
	{
		return new PHPStan\Rules\Arrays\ArrayDestructuringRule($this->getService('0182'), $this->getService('0131'));
	}


	public function createServiceRules__178(): PHPStan\Rules\Arrays\ArrayUnpackingRule
	{
		return new PHPStan\Rules\Arrays\ArrayUnpackingRule($this->getService('026'), $this->getService('0182'));
	}


	public function createServiceRules__179(): PHPStan\Rules\Arrays\IterableInForeachRule
	{
		return new PHPStan\Rules\Arrays\IterableInForeachRule($this->getService('0182'));
	}


	public function createServiceRules__18(): PHPStan\Rules\Api\ApiClassImplementsRule
	{
		return new PHPStan\Rules\Api\ApiClassImplementsRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__180(): PHPStan\Rules\Arrays\OffsetAccessAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($this->getService('0182'));
	}


	public function createServiceRules__181(): PHPStan\Rules\Arrays\OffsetAccessAssignOpRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignOpRule($this->getService('0182'));
	}


	public function createServiceRules__182(): PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule($this->getService('0182'));
	}


	public function createServiceRules__183(): PHPStan\Rules\Arrays\UnpackIterableInArrayRule
	{
		return new PHPStan\Rules\Arrays\UnpackIterableInArrayRule($this->getService('0182'));
	}


	public function createServiceRules__184(): PHPStan\Rules\Exceptions\ThrowExprTypeRule
	{
		return new PHPStan\Rules\Exceptions\ThrowExprTypeRule($this->getService('0182'));
	}


	public function createServiceRules__185(): PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule($this->getService('0149'));
	}


	public function createServiceRules__186(): PHPStan\Rules\Functions\ClosureReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ClosureReturnTypeRule($this->getService('0149'));
	}


	public function createServiceRules__187(): PHPStan\Rules\Functions\ReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ReturnTypeRule($this->getService('0149'));
	}


	public function createServiceRules__188(): PHPStan\Rules\Generators\YieldTypeRule
	{
		return new PHPStan\Rules\Generators\YieldTypeRule($this->getService('0182'));
	}


	public function createServiceRules__189(): PHPStan\Rules\Methods\ReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ReturnTypeRule($this->getService('0149'));
	}


	public function createServiceRules__19(): PHPStan\Rules\Api\ApiInterfaceExtendsRule
	{
		return new PHPStan\Rules\Api\ApiInterfaceExtendsRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__190(): PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule($this->getService('0182'));
	}


	public function createServiceRules__191(): PHPStan\Rules\Properties\GetNonVirtualPropertyHookReadRule
	{
		return new PHPStan\Rules\Properties\GetNonVirtualPropertyHookReadRule;
	}


	public function createServiceRules__192(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule($this->getService('0180'), $this->getService('0110'));
	}


	public function createServiceRules__193(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule($this->getService('0180'), $this->getService('0110'));
	}


	public function createServiceRules__194(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule($this->getService('0180'));
	}


	public function createServiceRules__195(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule($this->getService('0180'));
	}


	public function createServiceRules__196(): PHPStan\Rules\Properties\SetNonVirtualPropertyHookAssignRule
	{
		return new PHPStan\Rules\Properties\SetNonVirtualPropertyHookAssignRule;
	}


	public function createServiceRules__197(): PHPStan\Rules\Properties\TypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\TypesAssignedToPropertiesRule($this->getService('0182'), $this->getService('0180'));
	}


	public function createServiceRules__198(): PHPStan\Rules\Variables\ParameterOutAssignedTypeRule
	{
		return new PHPStan\Rules\Variables\ParameterOutAssignedTypeRule($this->getService('0182'));
	}


	public function createServiceRules__199(): PHPStan\Rules\Variables\ParameterOutExecutionEndTypeRule
	{
	...
	public function createServiceRules__20(): PHPStan\Rules\Api\ApiMethodCallRule
	{
		return new PHPStan\Rules\Api\ApiMethodCallRule($this->getService('0129'));
	}


	public function createServiceRules__200(): PHPStan\Rules\Variables\VariableCloningRule
	{
		return new PHPStan\Rules\Variables\VariableCloningRule($this->getService('0182'));
	}


	public function createServiceRules__201(): PHPStan\Rules\Arrays\DeadForeachRule
	{
		return new PHPStan\Rules\Arrays\DeadForeachRule;
	}


	public function createServiceRules__202(): PHPStan\Rules\DeadCode\CallToConstructorStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToConstructorStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__203(): PHPStan\Rules\DeadCode\CallToFunctionStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToFunctionStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__204(): PHPStan\Rules\DeadCode\CallToMethodStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToMethodStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__205(): PHPStan\Rules\DeadCode\CallToStaticMethodStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToStaticMethodStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__206(): PHPStan\Rules\DeadCode\NoopRule
	{
		return new PHPStan\Rules\DeadCode\NoopRule($this->getService('023'));
	}


	public function createServiceRules__207(): PHPStan\Rules\DeadCode\UnreachableStatementRule
	{
		return new PHPStan\Rules\DeadCode\UnreachableStatementRule;
	}


	public function createServiceRules__208(): PHPStan\Rules\DeadCode\UnusedPrivateConstantRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateConstantRule($this->getService('0166'));
	}


	public function createServiceRules__209(): PHPStan\Rules\DeadCode\UnusedPrivateMethodRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateMethodRule($this->getService('0167'));
	}


	public function createServiceRules__21(): PHPStan\Rules\Api\ApiStaticCallRule
	{
		return new PHPStan\Rules\Api\ApiStaticCallRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__210(): PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule
	{
		return new PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule;
	}


	public function createServiceRules__211(): PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__212(): PHPStan\Rules\Functions\UselessFunctionReturnValueRule
	{
		return new PHPStan\Rules\Functions\UselessFunctionReturnValueRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__213(): PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__214(): PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule($this->getService('0182'));
	}


	public function createServiceRules__215(): PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule
	{
	...
	public function createServiceRules__216(): PHPStan\Rules\Methods\NullsafeMethodCallRule
	{
		return new PHPStan\Rules\Methods\NullsafeMethodCallRule;
	}


	public function createServiceRules__217(): PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule;
	}


	public function createServiceRules__218(): PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule;
	}


	public function createServiceRules__219(): PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule;
	}


	public function createServiceRules__22(): PHPStan\Rules\Api\ApiTraitUseRule
	{
		return new PHPStan\Rules\Api\ApiTraitUseRule($this->getService('0129'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__220(): PHPStan\Rules\TooWideTypehints\TooWideFunctionParameterOutTypeRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionParameterOutTypeRule($this->getService('0184'));
	}


	public function createServiceRules__221(): PHPStan\Rules\TooWideTypehints\TooWideMethodParameterOutTypeRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodParameterOutTypeRule($this->getService('0184'));
	}


	public function createServiceRules__222(): PHPStan\Rules\TooWideTypehints\TooWidePropertyTypeRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWidePropertyTypeRule($this->getService('0178'), $this->getService('0180'));
	}


	public function createServiceRules__223(): PHPStan\Rules\Traits\NotAnalysedTraitRule
	{
		return new PHPStan\Rules\Traits\NotAnalysedTraitRule;
	}


	public function createServiceRules__224(): PHPStan\Rules\DateTimeInstantiationRule
	{
		return new PHPStan\Rules\DateTimeInstantiationRule;
	}


	public function createServiceRules__225(): PHPStan\Rules\Functions\CallUserFuncRule
	{
		return new PHPStan\Rules\Functions\CallUserFuncRule($this->getService('reflectionProvider'), $this->getService('0147'));
	}


	public function createServiceRules__226(): PHPStan\Rules\Functions\ParameterCastableToStringRule
	{
	...
	public function createServiceRules__227(): PHPStan\Rules\Functions\ImplodeParameterCastableToStringRule
	{
	...
	public function createServiceRules__228(): PHPStan\Rules\Functions\SortParameterCastableToStringRule
	{
	...
	public function createServiceRules__229(): PHPStan\Rules\Regexp\RegularExpressionQuotingRule
	{
		return new PHPStan\Rules\Regexp\RegularExpressionQuotingRule($this->getService('reflectionProvider'), $this->getService('0279'));
	}


	public function createServiceRules__23(): PHPStan\Rules\Api\GetTemplateTypeRule
	{
		return new PHPStan\Rules\Api\GetTemplateTypeRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__230(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0164'));
	}


	public function createServiceRules__231(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0164'));
	}


	public function createServiceRules__232(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0164'));
	}


	public function createServiceRules__233(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0164'));
	}


	public function createServiceRules__234(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0164'));
	}


	public function createServiceRules__235(): PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule
	{
		return new PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule($this->getService('0164'));
	}


	public function createServiceRules__236(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0164'));
	}


	public function createServiceRules__237(): Larastan\Larastan\Rules\UselessConstructs\NoUselessWithFunctionCallsRule
	{
		return new Larastan\Larastan\Rules\UselessConstructs\NoUselessWithFunctionCallsRule;
	}


	public function createServiceRules__238(): Larastan\Larastan\Rules\UselessConstructs\NoUselessValueFunctionCallsRule
	{
		return new Larastan\Larastan\Rules\UselessConstructs\NoUselessValueFunctionCallsRule;
	}


	public function createServiceRules__239(): Larastan\Larastan\Rules\DeferrableServiceProviderMissingProvidesRule
	{
		return new Larastan\Larastan\Rules\DeferrableServiceProviderMissingProvidesRule;
	}


	public function createServiceRules__24(): PHPStan\Rules\Api\NodeConnectingVisitorAttributesRule
	{
		return new PHPStan\Rules\Api\NodeConnectingVisitorAttributesRule;
	}


	public function createServiceRules__240(): Larastan\Larastan\Rules\ConsoleCommand\UndefinedArgumentOrOptionRule
	{
		return new Larastan\Larastan\Rules\ConsoleCommand\UndefinedArgumentOrOptionRule($this->getService('0551'));
	}


	public function createServiceRules__25(): PHPStan\Rules\Api\OldPhpParser4ClassRule
	{
		return new PHPStan\Rules\Api\OldPhpParser4ClassRule;
	}


	public function createServiceRules__26(): PHPStan\Rules\Api\PhpStanNamespaceIn3rdPartyPackageRule
	{
		return new PHPStan\Rules\Api\PhpStanNamespaceIn3rdPartyPackageRule($this->getService('0129'));
	}


	public function createServiceRules__27(): PHPStan\Rules\Api\RuntimeReflectionInstantiationRule
	{
		return new PHPStan\Rules\Api\RuntimeReflectionInstantiationRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__28(): PHPStan\Rules\Api\RuntimeReflectionFunctionRule
	{
		return new PHPStan\Rules\Api\RuntimeReflectionFunctionRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__29(): PHPStan\Rules\Arrays\DuplicateKeysInLiteralArraysRule
	{
	...
	public function createServiceRules__30(): PHPStan\Rules\Arrays\OffsetAccessWithoutDimForReadingRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessWithoutDimForReadingRule;
	}


	public function createServiceRules__31(): PHPStan\Rules\Cast\UnsetCastRule
	{
		return new PHPStan\Rules\Cast\UnsetCastRule($this->getService('026'));
	}


	public function createServiceRules__32(): PHPStan\Rules\Classes\AllowedSubTypesRule
	{
		return new PHPStan\Rules\Classes\AllowedSubTypesRule;
	}


	public function createServiceRules__33(): PHPStan\Rules\Classes\ClassAttributesRule
	{
		return new PHPStan\Rules\Classes\ClassAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__34(): PHPStan\Rules\Classes\ClassConstantAttributesRule
	{
		return new PHPStan\Rules\Classes\ClassConstantAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__35(): PHPStan\Rules\Classes\ClassConstantRule
	{
	...
	public function createServiceRules__36(): PHPStan\Rules\Classes\DuplicateDeclarationRule
	{
		return new PHPStan\Rules\Classes\DuplicateDeclarationRule;
	}


	public function createServiceRules__37(): PHPStan\Rules\Classes\EnumSanityRule
	{
		return new PHPStan\Rules\Classes\EnumSanityRule;
	}


	public function createServiceRules__38(): PHPStan\Rules\Classes\InstantiationCallableRule
	{
		return new PHPStan\Rules\Classes\InstantiationCallableRule;
	}


	public function createServiceRules__39(): PHPStan\Rules\Classes\InvalidPromotedPropertiesRule
	{
	...
	public function createServiceRules__40(): PHPStan\Rules\Classes\LocalTypeAliasesRule
	{
		return new PHPStan\Rules\Classes\LocalTypeAliasesRule($this->getService('0135'));
	}


	public function createServiceRules__41(): PHPStan\Rules\Classes\LocalTypeTraitUseAliasesRule
	{
		return new PHPStan\Rules\Classes\LocalTypeTraitUseAliasesRule($this->getService('0135'));
	}


	public function createServiceRules__42(): PHPStan\Rules\Classes\LocalTypeTraitAliasesRule
	{
		return new PHPStan\Rules\Classes\LocalTypeTraitAliasesRule($this->getService('0135'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__43(): PHPStan\Rules\Classes\NewStaticRule
	{
		return new PHPStan\Rules\Classes\NewStaticRule;
	}


	public function createServiceRules__44(): PHPStan\Rules\Classes\NonClassAttributeClassRule
	{
		return new PHPStan\Rules\Classes\NonClassAttributeClassRule;
	}


	public function createServiceRules__45(): PHPStan\Rules\Classes\ReadOnlyClassRule
	{
		return new PHPStan\Rules\Classes\ReadOnlyClassRule($this->getService('026'));
	}


	public function createServiceRules__46(): PHPStan\Rules\Classes\TraitAttributeClassRule
	{
		return new PHPStan\Rules\Classes\TraitAttributeClassRule;
	}


	public function createServiceRules__47(): PHPStan\Rules\Constants\ClassAsClassConstantRule
	{
		return new PHPStan\Rules\Constants\ClassAsClassConstantRule;
	}


	public function createServiceRules__48(): PHPStan\Rules\Constants\DynamicClassConstantFetchRule
	{
		return new PHPStan\Rules\Constants\DynamicClassConstantFetchRule($this->getService('026'), $this->getService('0182'));
	}


	public function createServiceRules__49(): PHPStan\Rules\Constants\FinalConstantRule
	{
	...
	public function createServiceRules__50(): PHPStan\Rules\Constants\MagicConstantContextRule
	{
		return new PHPStan\Rules\Constants\MagicConstantContextRule;
	}


	public function createServiceRules__51(): PHPStan\Rules\Constants\NativeTypedClassConstantRule
	{
		return new PHPStan\Rules\Constants\NativeTypedClassConstantRule($this->getService('026'));
	}


	public function createServiceRules__52(): PHPStan\Rules\Constants\FinalPrivateConstantRule
	{
		return new PHPStan\Rules\Constants\FinalPrivateConstantRule;
	}


	public function createServiceRules__53(): PHPStan\Rules\EnumCases\EnumCaseAttributesRule
	{
		return new PHPStan\Rules\EnumCases\EnumCaseAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__54(): PHPStan\Rules\Exceptions\NoncapturingCatchRule
	{
		return new PHPStan\Rules\Exceptions\NoncapturingCatchRule;
	}


	public function createServiceRules__55(): PHPStan\Rules\Exceptions\ThrowExpressionRule
	{
		return new PHPStan\Rules\Exceptions\ThrowExpressionRule($this->getService('026'));
	}


	public function createServiceRules__56(): PHPStan\Rules\Functions\ArrowFunctionAttributesRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__57(): PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule($this->getService('0165'));
	}


	public function createServiceRules__58(): PHPStan\Rules\Functions\ClosureAttributesRule
	{
		return new PHPStan\Rules\Functions\ClosureAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__59(): PHPStan\Rules\Functions\DefineParametersRule
	{
	...
	public function createServiceRules__60(): PHPStan\Rules\Functions\ExistingClassesInArrowFunctionTypehintsRule
	{
	...
	public function createServiceRules__61(): PHPStan\Rules\Functions\CallToFunctionParametersRule
	{
	...
	public function createServiceRules__62(): PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule
	{
		return new PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule($this->getService('0148'));
	}


	public function createServiceRules__63(): PHPStan\Rules\Functions\ExistingClassesInTypehintsRule
	{
		return new PHPStan\Rules\Functions\ExistingClassesInTypehintsRule($this->getService('0148'));
	}


	public function createServiceRules__64(): PHPStan\Rules\Functions\FunctionAttributesRule
	{
		return new PHPStan\Rules\Functions\FunctionAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__65(): PHPStan\Rules\Functions\InnerFunctionRule
	{
		return new PHPStan\Rules\Functions\InnerFunctionRule;
	}


	public function createServiceRules__66(): PHPStan\Rules\Functions\InvalidLexicalVariablesInClosureUseRule
	{
		return new PHPStan\Rules\Functions\InvalidLexicalVariablesInClosureUseRule;
	}


	public function createServiceRules__67(): PHPStan\Rules\Functions\ParamAttributesRule
	{
		return new PHPStan\Rules\Functions\ParamAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__68(): PHPStan\Rules\Functions\PrintfArrayParametersRule
	{
		return new PHPStan\Rules\Functions\PrintfArrayParametersRule($this->getService('0359'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__69(): PHPStan\Rules\Functions\PrintfParametersRule
	{
		return new PHPStan\Rules\Functions\PrintfParametersRule($this->getService('0359'), $this->getService('reflectionProvider'));
	}
	...
	public function createServiceRules__70(): PHPStan\Rules\Functions\RedefinedParametersRule
	{
		return new PHPStan\Rules\Functions\RedefinedParametersRule;
	}


	public function createServiceRules__71(): PHPStan\Rules\Functions\ReturnNullsafeByRefRule
	{
		return new PHPStan\Rules\Functions\ReturnNullsafeByRefRule($this->getService('0165'));
	}


	public function createServiceRules__72(): PHPStan\Rules\Ignore\IgnoreParseErrorRule
	{
		return new PHPStan\Rules\Ignore\IgnoreParseErrorRule;
	}


	public function createServiceRules__73(): PHPStan\Rules\Functions\VariadicParametersDeclarationRule
	{
		return new PHPStan\Rules\Functions\VariadicParametersDeclarationRule;
	}


	public function createServiceRules__74(): PHPStan\Rules\Keywords\ContinueBreakInLoopRule
	{
		return new PHPStan\Rules\Keywords\ContinueBreakInLoopRule;
	}


	public function createServiceRules__75(): PHPStan\Rules\Keywords\DeclareStrictTypesRule
	{
		return new PHPStan\Rules\Keywords\DeclareStrictTypesRule($this->getService('023'));
	}


	public function createServiceRules__76(): PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule
	{
		return new PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule;
	}


	public function createServiceRules__77(): PHPStan\Rules\Methods\AbstractPrivateMethodRule
	{
		return new PHPStan\Rules\Methods\AbstractPrivateMethodRule;
	}


	public function createServiceRules__78(): PHPStan\Rules\Methods\CallMethodsRule
	{
		return new PHPStan\Rules\Methods\CallMethodsRule($this->getService('0159'), $this->getService('0147'));
	}


	public function createServiceRules__79(): PHPStan\Rules\Methods\CallStaticMethodsRule
	{
	...
	public function createServiceRules__80(): PHPStan\Rules\Methods\ConsistentConstructorRule
	{
		return new PHPStan\Rules\Methods\ConsistentConstructorRule($this->getService('0162'), $this->getService('0163'));
	}


	public function createServiceRules__81(): PHPStan\Rules\Methods\ConstructorReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ConstructorReturnTypeRule;
	}


	public function createServiceRules__82(): PHPStan\Rules\Methods\ExistingClassesInTypehintsRule
	{
		return new PHPStan\Rules\Methods\ExistingClassesInTypehintsRule($this->getService('0148'));
	}


	public function createServiceRules__83(): PHPStan\Rules\Methods\FinalPrivateMethodRule
	{
		return new PHPStan\Rules\Methods\FinalPrivateMethodRule;
	}


	public function createServiceRules__84(): PHPStan\Rules\Methods\MethodCallableRule
	{
		return new PHPStan\Rules\Methods\MethodCallableRule($this->getService('0159'), $this->getService('026'));
	}


	public function createServiceRules__85(): PHPStan\Rules\Methods\MethodVisibilityInInterfaceRule
	{
		return new PHPStan\Rules\Methods\MethodVisibilityInInterfaceRule;
	}


	public function createServiceRules__86(): PHPStan\Rules\Methods\MissingMagicSerializationMethodsRule
	{
		return new PHPStan\Rules\Methods\MissingMagicSerializationMethodsRule($this->getService('026'));
	}


	public function createServiceRules__87(): PHPStan\Rules\Methods\MissingMethodImplementationRule
	{
		return new PHPStan\Rules\Methods\MissingMethodImplementationRule;
	}


	public function createServiceRules__88(): PHPStan\Rules\Methods\MethodAttributesRule
	{
		return new PHPStan\Rules\Methods\MethodAttributesRule($this->getService('0130'));
	}


	public function createServiceRules__89(): PHPStan\Rules\Methods\StaticMethodCallableRule
	{
	...
	public function createServiceRules__90(): PHPStan\Rules\Names\UsedNamesRule
	{
		return new PHPStan\Rules\Names\UsedNamesRule;
	}


	public function createServiceRules__91(): PHPStan\Rules\Operators\InvalidAssignVarRule
	{
		return new PHPStan\Rules\Operators\InvalidAssignVarRule($this->getService('0165'));
	}


	public function createServiceRules__92(): PHPStan\Rules\Operators\InvalidIncDecOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidIncDecOperationRule($this->getService('0182'));
	}


	public function createServiceRules__93(): PHPStan\Rules\Properties\AccessPropertiesInAssignRule
	{
		return new PHPStan\Rules\Properties\AccessPropertiesInAssignRule($this->getService('0175'));
	}


	public function createServiceRules__94(): PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule
	{
		return new PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule($this->getService('0383'));
	}


	public function createServiceRules__95(): PHPStan\Rules\Properties\ExistingClassesInPropertyHookTypehintsRule
	{
		return new PHPStan\Rules\Properties\ExistingClassesInPropertyHookTypehintsRule($this->getService('0148'));
	}


	public function createServiceRules__96(): PHPStan\Rules\Properties\InvalidCallablePropertyTypeRule
	{
		return new PHPStan\Rules\Properties\InvalidCallablePropertyTypeRule;
	}


	public function createServiceRules__97(): PHPStan\Rules\Properties\MissingReadOnlyPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\MissingReadOnlyPropertyAssignRule($this->getService('0110'));
	}


	public function createServiceRules__98(): PHPStan\Rules\Properties\MissingReadOnlyByPhpDocPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\MissingReadOnlyByPhpDocPropertyAssignRule($this->getService('0110'));
	}


	public function createServiceRules__99(): PHPStan\Rules\Properties\PropertiesInInterfaceRule
	{
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/Users/mantum/Documents/test-paypal');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 8,
			'paths' => ['/Users/mantum/Documents/test-paypal/app', '/Users/mantum/Documents/test-paypal/tests'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => '/Users/mantum/Documents/test-paypal/.phpstan-cache/resultCache.php',
			...
			'tmpDir' => '/Users/mantum/Documents/test-paypal/.phpstan-cache',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/Users/mantum/Documents/test-paypal/.phpstan-cache',
			'rootDir' => '/Users/mantum/Documents/test-paypal/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/Users/mantum/Documents/test-paypal',
			...
			'composerAutoloaderProjectPaths' => ['/Users/mantum/Documents/test-paypal'],
			'generateBaselineFile' => null,
			'usedLevel' => '8',
			'cliAutoloadFile' => null,
			'env' => [
				'APP_FAKER_LOCALE' => 'en_US',
				'NVM_INC' => '/Users/mantum/.nvm/versions/node/v22.12.0/include/node',
				...
				'TERM_PROGRAM' => 'vscode',
				'NVM_CD_FLAGS' => '-q',
				'COMPOSER_BINARY' => '/opt/homebrew/Cellar/composer/2.8.6/bin/composer',
				'TERM' => 'xterm-256color',
				'SHELL' => '/bin/zsh',
				'SESSION_DOMAIN' => 'null',
				...
				'TMPDIR' => '/var/folders/0r/__wn6yxd729c3dnx0mkmp_kr0000gn/T/',
				'PAYPAL_MODE' => 'sandbox',
				...
				'ZDOTDIR' => '/Users/mantum',
				'APP_NAME' => 'VistualSoft',
				'TERM_SESSION_ID' => 'w0t0p0:9A68C232-115B-472C-9AD1-2DDC17120E3E',
				'ZSH' => '/Users/mantum/.oh-my-zsh',
				'AWS_BUCKET' => '',
				'MAIL_USERNAME' => 'null',
				'PAYPAL_NOTIFY_URL' => 'https://tudominio.com/webhook/paypal',
				'PAYPAL_CURRENCY' => 'USD',
				'NVM_DIR' => '/Users/mantum/.nvm',
				'USER' => 'mantum',
				'LS_COLORS' => 'di=1;36:ln=35:so=32:pi=33:ex=31:bd=34;46:cd=34;43:su=30;41:sg=30;46:tw=30;42:ow=30;43',
				'COMMAND_MODE' => 'unix2003',
				'MEMCACHED_HOST' => '127.0.0.1',
				'SSH_AUTH_SOCK' => '/private/tmp/com.apple.launchd.HuI3GGJx7k/Listeners',
				...
				'MAIL_MAILER' => 'log',
				'DB_CONNECTION' => 'pgsql',
				'PATH' => '/Users/mantum/Documents/test-paypal/vendor/bin:/Users/mantum/.nvm/versions/node/v22.12.0/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/Library/Apple/usr/bin:/Users/mantum/.nvm/versions/node/v22.12.0/bin:/Applications/iTerm.app/Contents/Resources/utilities',
				'TERMINFO_DIRS' => '/Applications/iTerm.app/Contents/Resources/terminfo:/usr/share/terminfo',
				'DB_DATABASE' => 'transactions',
				'REDIS_PASSWORD' => 'null',
				'_' => '/opt/homebrew/Cellar/php/8.4.5_1/bin/php',
				'AWS_DEFAULT_REGION' => 'us-east-1',
				'__CFBundleIdentifier' => 'com.microsoft.VSCode',
				'USER_ZDOTDIR' => '/Users/mantum',
				'PWD' => '/Users/mantum/Documents/test-paypal',
				'MAIL_FROM_NAME' => 'VistualSoft',
				...
				'APP_DEBUG' => 'true',
				'APP_KEY' => 'base64:0Y/p/gV//nt3XWf93lhvhdOODXfTd/IoOP7eDovOa1A=',
				'LINES' => '10',
				'XPC_SERVICE_NAME' => '0',
				'AWS_ACCESS_KEY_ID' => '',
				'SHELL_VERBOSITY' => '0',
				...
				'VITE_APP_NAME' => 'VistualSoft',
				'HOMEBREW_PREFIX' => '/opt/homebrew',
				'LOG_CHANNEL' => 'stack',
				'ITERM_SESSION_ID' => 'w0t0p0:9A68C232-115B-472C-9AD1-2DDC17120E3E',
				'PAYPAL_LIVE_CLIENT_SECRET' => '',
				'LOGNAME' => 'mantum',
				'LESS' => '-R',
				'MAIL_SCHEME' => 'null',
				'VSCODE_GIT_IPC_HANDLE' => '/var/folders/0r/__wn6yxd729c3dnx0mkmp_kr0000gn/T/vscode-git-22f5ee2ee9.sock',
				'PAYPAL_LIVE_APP_ID' => '',
				'SESSION_LIFETIME' => '120',
				'PAYPAL_SANDBOX_CLIENT_ID' => 'AeNXLKG6-R4EfljDgg5sNDgT4uJ6Ia2bN4TjeYMV96lSUHRTlxWD1Bn9K-FVGWcGt4_yPk_YgmLKo-r_',
				'NVM_BIN' => '/Users/mantum/.nvm/versions/node/v22.12.0/bin',
				...
				'BCRYPT_ROUNDS' => '12',
				'LC_TERMINAL' => 'iTerm2',
				'PAYPAL_SANDBOX_CLIENT_SECRET' => 'EPuywPuYZjNZHGe4eSxCHOKU7Ulf1TGKaw2y6pwmz7vXhO6XgaM-aYMLLuzxJiUzd8bBGzgexRHjg2F7',
				'MAIL_HOST' => '127.0.0.1',
