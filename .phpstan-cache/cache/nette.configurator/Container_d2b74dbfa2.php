...
class Container_d2b74dbfa2 extends _PHPStan_95d365e52\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_d2b74dbfa2 $container)
			{
	...
	public function createServiceContainer(): Container_d2b74dbfa2
	{
		return $this;
	}
